// Support Wasm. // Copyright (c) Charlie Poole, Rob Prouse and Contributors. MIT License - see LICENSE.txt
...
namespace NUnit.Framework.Api {
    ...
    /// </summary>
    public class WasmDefaultTestAssemblyBuilder : ITestAssemblyBuilder {
        private static readonly Logger Log = InternalTrace.GetLogger(typeof(WasmDefaultTestAssemblyBuilder));
        ...
        /// </summary>
        public WasmDefaultTestAssemblyBuilder() {
        ...
        private TestSuite Build(Assembly assembly, string assemblyNameOrPath, IDictionary<string, object> options) {
            ...
            try {
                ...
                var fixtures = GetFixtures(assembly, null);
        ...
        private IList<Test> GetFixtures(Assembly assembly, object? filter) { //  PreFilter filter
            ...
            var testTypes = assembly.GetTypes().ToList();
