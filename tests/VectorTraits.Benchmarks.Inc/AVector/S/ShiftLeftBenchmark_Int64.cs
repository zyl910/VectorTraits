...
namespace Zyl.VectorTraits.Benchmarks.AVector.S {
    ...
    public partial class ShiftLeftBenchmark_Int64 : AbstractSharedBenchmark_Int64 {
        ...
        private static unsafe TMy StaticSumSLL_Base128(TMy[] src, int srcCount, int shiftAmount) {
            ...
            fixed (TMy* p0 = &src[0]) {
                ...
                // Vector processs.
                for (i = 0; i < cntBlock; ++i) {
                    Vector<TMy> vtemp = VectorTraits128Base.Statics.ShiftLeft_Basic(*(Vector<TMy>*)p, shiftAmount);
                    vrt += vtemp; // Add.
                    p += nBlockWidth;
                }
                // Remainder processs.
        ...
        private static unsafe TMy StaticSumSLL_Base256(TMy[] src, int srcCount, int shiftAmount) {
            ...
            fixed (TMy* p0 = &src[0]) {
                ...
                // Vector processs.
                for (i = 0; i < cntBlock; ++i) {
                    Vector<TMy> vtemp = VectorTraits256Base.Statics.ShiftLeft_Basic(*(Vector<TMy>*)p, shiftAmount);
                    vrt += vtemp; // Add.
                    p += nBlockWidth;
                }
                // Remainder processs.
        ...
        /// <summary>
        /// Sum shift left logical - 512 Traits static.
        /// </summary>
        /// <param name="src">Source array.</param>
        /// <param name="srcCount">Source count</param>
        /// <param name="shiftAmount">Shift amount.</param>
        /// <returns>Returns the sum.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static unsafe TMy StaticSumSLL512Traits(TMy[] src, int srcCount, int shiftAmount) {
            TMy rt = 0; // Result.
            ...
            fixed (TMy* p0 = &src[0]) {
                ...
                // Vector512 processs.
                for (i = 0; i < cntBlock; ++i) {
                    Vector512<TMy> vtemp = Vector512s.ShiftLeft(*(Vector512<TMy>*)p, shiftAmount);
                    vrt += vtemp; // Add.
                    p += nBlockWidth;
                }
                // Remainder processs.
        ...
        /// <summary>
        /// Sum shift left logical - 512 Bcl static.
        /// </summary>
        /// <param name="src">Source array.</param>
        /// <param name="srcCount">Source count</param>
        /// <param name="shiftAmount">Shift amount.</param>
        /// <returns>Returns the sum.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static unsafe TMy StaticSumSLL512Bcl(TMy[] src, int srcCount, int shiftAmount) {
            TMy rt = 0; // Result.
            int VectorWidth = Vector512<TMy>.Count; // Block width.
            int nBlockWidth = VectorWidth; // Block width.
            int cntBlock = srcCount / nBlockWidth; // Block count.
            ...
            fixed (TMy* p0 = &src[0]) {
                ...
                // Vector512 processs.
                for (i = 0; i < cntBlock; ++i) {
                    Vector512<TMy> vtemp = Vector512.ShiftLeft(*(Vector512<TMy>*)p, shiftAmount);
                    vrt += vtemp; // Add.
                    p += nBlockWidth;
                }
                // Remainder processs.
        ...
        private static unsafe TMy StaticSumSLLFast_Base128(TMy[] src, int srcCount, int shiftAmount) {
            ...
            fixed (TMy* p0 = &src[0]) {
                ...
                // Vector processs.
                for (i = 0; i < cntBlock; ++i) {
                    Vector<TMy> vtemp = VectorTraits128Base.Statics.ShiftLeft_Fast_Basic(*(Vector<TMy>*)p, shiftAmount);
                    vrt += vtemp; // Add.
                    p += nBlockWidth;
                }
                // Remainder processs.
        ...
        private static unsafe TMy StaticSumSLLFast_Base256(TMy[] src, int srcCount, int shiftAmount) {
            ...
            fixed (TMy* p0 = &src[0]) {
                ...
                // Vector processs.
                for (i = 0; i < cntBlock; ++i) {
                    Vector<TMy> vtemp = VectorTraits256Base.Statics.ShiftLeft_Fast_Basic(*(Vector<TMy>*)p, shiftAmount);
                    vrt += vtemp; // Add.
                    p += nBlockWidth;
                }
                // Remainder processs.
