...
namespace Zyl.VectorTraits.Benchmarks.AVector.S {
    ...
    /// <summary>
    /// Shuffle benchmark - Int16.
    /// </summary>
#if NETCOREAPP3_0_OR_GREATER && DRY_JOB
    [DryJob]
#endif // NETCOREAPP3_0_OR_GREATER && DRY_JOB
    public partial class ShuffleBenchmark_Int16 : AbstractSharedBenchmark_Int16 {
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        private static TMy StaticSumYShuffleKernelVector256_Avx2_Multiply(TMy[] src, int srcCount, Vector<TMy> indices) {
            ...
            // a) Vector processs.
            for (i = 0; i < cntBlock; ++i) {
                Vector256<TMy> vtemp = WVectorTraits256Avx2.Statics.YShuffleKernel_Multiply(p0.AsUInt16(), indicesUsed.AsUInt16()).AsInt16();
        ...
        private static TMy StaticSumYShuffleKernelVector256_Avx2_ShiftLane(TMy[] src, int srcCount, Vector<TMy> indices) {
            ...
            // a) Vector processs.
            for (i = 0; i < cntBlock; ++i) {
                Vector256<TMy> vtemp = WVectorTraits256Avx2.Statics.YShuffleKernel_ShiftLane(p0.AsUInt16(), indicesUsed.AsUInt16()).AsInt16();
                vrt = WVectorTraits256Avx2.Statics.Add(vrt, vtemp);
                p0 = ref Unsafe.Add(ref p0, GroupSize);
            }
            // b) Remainder processs.
