...
namespace Zyl.VectorTraits.Benchmarks.AVector.S {
    ...
    public partial class ShuffleBenchmark_Int64 : AbstractSharedBenchmark_Int64 {
        ...
        /// <returns>Returns the sum.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static TMy StaticSumShuffleVectorTraits_Args2(TMy[] src, int srcCount, Vector<TMy> indices) {
            TMy rt = 0; // Result.
            const int GroupSize = 1;
            int VectorWidth = Vector<TMy>.Count; // Block width.
            int nBlockWidth = VectorWidth; // Block width.
        ...
        [Benchmark]
        public void SumShuffleVectorTraits_Args2() {
            if (BenchmarkUtil.IsLastRun) {
                Volatile.Write(ref dstTMy, 0);
                //Debugger.Break();
            }
            dstTMy = StaticSumShuffleVectorTraits_Args2(srcArray, srcArray.Length, indices);
            CheckResult("SumShuffleVectorTraits_Args2");
        }
        ...
        /// <returns>Returns the sum.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static TMy StaticSumYShuffleKernelVectorTraits_Args2(TMy[] src, int srcCount, Vector<TMy> indices) {
            TMy rt = 0; // Result.
            const int GroupSize = 1;
            int VectorWidth = Vector<TMy>.Count; // Block width.
            int nBlockWidth = VectorWidth; // Block width.
        ...
        [Benchmark]
        public void SumYShuffleKernelVectorTraits_Args2() {
            if (BenchmarkUtil.IsLastRun) {
                Volatile.Write(ref dstTMy, 0);
                //Debugger.Break();
            }
            dstTMy = StaticSumYShuffleKernelVectorTraits_Args2(srcArray, srcArray.Length, indices);
            CheckResult("SumYShuffleKernelVectorTraits_Args2");
        }
        ...
        [Benchmark]
        public void SumYShuffleKernelVector256_Avx2_AlignRight() {
            WVectorTraits256Avx2.Statics.ThrowForUnsupported(true);
            if (Vector<byte>.Count != Vector256<byte>.Count) {
                throw new NotSupportedException(string.Format("Vector byte size mismatch({0}!={1}) !", Vector<byte>.Count, Vector256<byte>.Count));
            }
            //Debugger.Break();
            dstTMy = StaticSumYShuffleKernelVector256_Avx2_AlignRight(srcArray, srcArray.Length, indices);
            CheckResult("SumYShuffleKernelVector256_Avx2_AlignRight");
        }
        ...
        [Benchmark]
        public void SumYShuffleKernelVector256_Avx2_DuplicateEven() {
            WVectorTraits256Avx2.Statics.ThrowForUnsupported(true);
            if (Vector<byte>.Count != Vector256<byte>.Count) {
                throw new NotSupportedException(string.Format("Vector byte size mismatch({0}!={1}) !", Vector<byte>.Count, Vector256<byte>.Count));
            }
            //Debugger.Break();
            dstTMy = StaticSumYShuffleKernelVector256_Avx2_DuplicateEven(srcArray, srcArray.Length, indices);
            CheckResult("SumYShuffleKernelVector256_Avx2_DuplicateEven");
        }
        ...
        [Benchmark]
        public void SumYShuffleKernelVector256_Avx2_Multiply() {
            WVectorTraits256Avx2.Statics.ThrowForUnsupported(true);
            if (Vector<byte>.Count != Vector256<byte>.Count) {
                throw new NotSupportedException(string.Format("Vector byte size mismatch({0}!={1}) !", Vector<byte>.Count, Vector256<byte>.Count));
            }
            //Debugger.Break();
            dstTMy = StaticSumYShuffleKernelVector256_Avx2_Multiply(srcArray, srcArray.Length, indices);
            CheckResult("SumYShuffleKernelVector256_Avx2_Multiply");
        }
        ...
        [Benchmark]
        public void SumYShuffleKernelVector256_Avx2_ShiftLane() {
            WVectorTraits256Avx2.Statics.ThrowForUnsupported(true);
            if (Vector<byte>.Count != Vector256<byte>.Count) {
                throw new NotSupportedException(string.Format("Vector byte size mismatch({0}!={1}) !", Vector<byte>.Count, Vector256<byte>.Count));
            }
            //Debugger.Break();
            dstTMy = StaticSumYShuffleKernelVector256_Avx2_ShiftLane(srcArray, srcArray.Length, indices);
            CheckResult("SumYShuffleKernelVector256_Avx2_ShiftLane");
        }
        ...
        /// <returns>Returns the sum.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static TMy StaticSumYShuffleKernelVector256Traits_Args2(TMy[] src, int srcCount, Vector<TMy> indices) {
            TMy rt = 0; // Result.
            const int GroupSize = 1;
            int VectorWidth = Vector256<TMy>.Count; // Block width.
            int nBlockWidth = VectorWidth; // Block width.
        ...
        [Benchmark]
        public void SumYShuffleKernelVector256Traits_Args2() {
            Vector256s.ThrowForUnsupported(true);
            if (Vector<byte>.Count != Vector256<byte>.Count) {
                throw new NotSupportedException(string.Format("Vector byte size mismatch({0}!={1}) !", Vector<byte>.Count, Vector256<byte>.Count));
            }
            ...
            dstTMy = StaticSumYShuffleKernelVector256Traits_Args2(srcArray, srcArray.Length, indices);
            CheckResult("SumYShuffleKernelVector256Traits_Args2");
        }
