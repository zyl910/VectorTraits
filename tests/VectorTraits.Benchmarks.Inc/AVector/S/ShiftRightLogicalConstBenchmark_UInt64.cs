...
namespace Zyl.VectorTraits.Benchmarks.AVector.S {
    ...
    /// <summary>
    /// Shift right logical benchmark - UInt64.
    /// </summary>
#if NETCOREAPP3_0_OR_GREATER && DRY_JOB
    [DryJob]
#endif // NETCOREAPP3_0_OR_GREATER && DRY_JOB
    public partial class ShiftRightLogicalConstBenchmark_UInt64 : AbstractSharedBenchmark_UInt64 {
        ...
        /// <param name="shiftAmount">Shift amount.</param>
        /// <returns>Returns the sum.</returns>
        private static TMy StaticSumSRL128Bcl(TMy[] src, int srcCount, int shiftAmount) {
            TMy rt = 0; // Result.
            const int GroupSize = 1;
            ...
            // Vector processs.
            for (i = 0; i < cntBlock; ++i) {
                Vector128<TMy> vtemp = Vector128.ShiftRightLogical(p0, shiftAmount);
        ...
        [Benchmark]
        public void SumSRL128Bcl() {
            Vector128s.ThrowForUnsupported(true);
            if (BenchmarkUtil.IsLastRun) {
                Volatile.Write(ref dstTMy, 0);
                //Debugger.Break();
            }
            dstTMy = StaticSumSRL128Bcl(srcArray, srcArray.Length, shiftAmount);
            CheckResult("SumSRL128Bcl");
        }
#endif // NET7_0_OR_GREATER
