...
namespace Zyl.VectorTraits.Benchmarks.AVector.S {
    ...
    internal partial class ShiftRightArithmeticBenchmark_Int32 : AbstractSharedBenchmark_Int32 {
        ...
        public void SumSRAScalar() {
            ...
            if (CheckMode) {
                baselineTMy = dstTMy;
                BenchmarkUtil.WriteLine(string.Format("# SumSRAScalar:\t{0}", baselineTMy));
            }
        }

#if NET7_0_OR_GREATER
        /// <summary>
        /// Sum shift right arithmetic logical - VectorT - .NET7.
        /// </summary>
        /// <param name="src">Source array.</param>
        /// <param name="srcCount">Source count</param>
        /// <param name="shiftAmount">Shift amount.</param>
        /// <returns>Returns the sum.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static unsafe TMy StaticSumSRANet7(TMy[] src, int srcCount, int shiftAmount) {
            TMy rt = 0; // Result.
        ...
        [Benchmark]
        public void SumSRANet7() {
            //Debugger.Break();
            dstTMy = 0;
            for (int shiftAmount = ShiftAmountMin; shiftAmount <= ShiftAmountMax; ++shiftAmount) {
                dstTMy += StaticSumSRANet7(srcArray, srcArray.Length, shiftAmount);
            }
            CheckResult("SumSRANet7");
        }
        ...
        ///// <summary>
        ///// Sum shift right arithmetic logical - Algorithm - 256Base.
        ///// </summary>
        ///// <param name="src">Source array.</param>
        ///// <param name="srcCount">Source count</param>
        ///// <param name="shiftAmount">Shift amount.</param>
        ...
        ///// <summary>
        ///// Sum shift right arithmetic logical fast - Algorithm - 256Base.
        ///// </summary>
        ///// <param name="src">Source array.</param>
        ///// <param name="srcCount">Source count</param>
        ///// <param name="shiftAmount">Shift amount.</param>
