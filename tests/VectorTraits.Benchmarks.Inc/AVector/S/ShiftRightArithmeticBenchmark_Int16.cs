...
namespace Zyl.VectorTraits.Benchmarks.AVector.S {
    ...
    /// <summary>
    /// Shift right arithmetic benchmark - Int16.
    /// </summary>
#if NETCOREAPP3_0_OR_GREATER && DRY_JOB
    [DryJob]
#endif // NETCOREAPP3_0_OR_GREATER && DRY_JOB
    public partial class ShiftRightArithmeticBenchmark_Int16 : AbstractSharedBenchmark_Int16 {
        ...
        private static unsafe TMy StaticSumSRA_Base128(TMy[] src, int srcCount, int shiftAmount) {
            ...
            fixed (TMy* p0 = &src[0]) {
                ...
                // Vector processs.
                for (i = 0; i < cntBlock; ++i) {
                    Vector<TMy> vtemp = VectorTraits128Base.Statics.ShiftRightArithmetic_Basic(*(Vector<TMy>*)p, shiftAmount);
                    vrt += vtemp; // Add.
                    p += nBlockWidth;
                }
                // Remainder processs.
        ...
        private static unsafe TMy StaticSumSRA_Base256(TMy[] src, int srcCount, int shiftAmount) {
            ...
            fixed (TMy* p0 = &src[0]) {
                ...
                // Vector processs.
                for (i = 0; i < cntBlock; ++i) {
                    Vector<TMy> vtemp = VectorTraits256Base.Statics.ShiftRightArithmetic_Basic(*(Vector<TMy>*)p, shiftAmount);
                    vrt += vtemp; // Add.
                    p += nBlockWidth;
                }
                // Remainder processs.
        ...
        /// <summary>
        /// Sum shift right arithmetic - 512 Traits static.
        /// </summary>
        /// <param name="src">Source array.</param>
        /// <param name="srcCount">Source count</param>
        /// <param name="shiftAmount">Shift amount.</param>
        /// <returns>Returns the sum.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static unsafe TMy StaticSumSRA512Traits(TMy[] src, int srcCount, int shiftAmount) {
            TMy rt = 0; // Result.
            ...
            fixed (TMy* p0 = &src[0]) {
                ...
                // Vector512 processs.
                for (i = 0; i < cntBlock; ++i) {
                    Vector512<TMy> vtemp = Vector512s.ShiftRightArithmetic(*(Vector512<TMy>*)p, shiftAmount);
                    vrt += vtemp; // Add.
                    p += nBlockWidth;
                }
                // Remainder processs.
        ...
        /// <summary>
        /// Sum shift right arithmetic - 512 Bcl static.
        /// </summary>
        /// <param name="src">Source array.</param>
        /// <param name="srcCount">Source count</param>
        /// <param name="shiftAmount">Shift amount.</param>
        /// <returns>Returns the sum.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static unsafe TMy StaticSumSRA512Bcl(TMy[] src, int srcCount, int shiftAmount) {
            TMy rt = 0; // Result.
            int VectorWidth = Vector512<TMy>.Count; // Block width.
            int nBlockWidth = VectorWidth; // Block width.
            int cntBlock = srcCount / nBlockWidth; // Block count.
            ...
            fixed (TMy* p0 = &src[0]) {
                ...
                // Vector512 processs.
                for (i = 0; i < cntBlock; ++i) {
                    Vector512<TMy> vtemp = Vector512.ShiftRightArithmetic(*(Vector512<TMy>*)p, shiftAmount);
                    vrt += vtemp; // Add.
                    p += nBlockWidth;
                }
                // Remainder processs.
        ...
        private static unsafe TMy StaticSumSRAFast_Base128(TMy[] src, int srcCount, int shiftAmount) {
            ...
            fixed (TMy* p0 = &src[0]) {
                ...
                // Vector processs.
                for (i = 0; i < cntBlock; ++i) {
                    Vector<TMy> vtemp = VectorTraits128Base.Statics.ShiftRightArithmetic_Fast_Basic(*(Vector<TMy>*)p, shiftAmount);
                    vrt += vtemp; // Add.
                    p += nBlockWidth;
                }
                // Remainder processs.
        ...
        private static unsafe TMy StaticSumSRAFast_Base256(TMy[] src, int srcCount, int shiftAmount) {
            ...
            fixed (TMy* p0 = &src[0]) {
                ...
                // Vector processs.
                for (i = 0; i < cntBlock; ++i) {
                    Vector<TMy> vtemp = VectorTraits256Base.Statics.ShiftRightArithmetic_Fast_Basic(*(Vector<TMy>*)p, shiftAmount);
                    vrt += vtemp; // Add.
                    p += nBlockWidth;
                }
                // Remainder processs.
