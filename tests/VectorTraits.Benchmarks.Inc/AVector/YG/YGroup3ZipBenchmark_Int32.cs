...
namespace Zyl.VectorTraits.Benchmarks.AVector.YG {
    ...
    /// <summary>
    /// YGroup3Zip benchmark - Int32.
    /// </summary>
#if NETCOREAPP3_0_OR_GREATER && DRY_JOB
    [DryJob]
#endif // NETCOREAPP3_0_OR_GREATER && DRY_JOB
    public partial class YGroup3ZipBenchmark_Int32 : AbstractSharedBenchmark_Int32 {
        ...
        /// <summary>
        /// Sum YGroup3Zip - Vector - base - ByX2Unzip.
        /// </summary>
        /// <param name="src">Source array.</param>
        /// <param name="srcCount">Source count</param>
        /// <returns>Returns the sum.</returns>
        private static TMy StaticSumBase_ByX2Unzip(TMy[] src, int srcCount) {
            TMy rt = 0; // Result.
            const int GroupSize = 1;
            int VectorWidth = Vector<TMy>.Count; // Block width.
            int nBlockWidth = VectorWidth * GroupSize; // Block width.
            ...
            // a) Vector processs.
            for (i = 0; i < cntBlock; ++i) {
                Vector<TMy> vtemp = VectorTraitsBase.Statics.YGroup3Zip_ByX2Unzip(p0, vector1Used, vector2Used, out var vtemp1, out var vtemp2);
                vrt = Vector.Add(vrt, vtemp);
                vrt1 = Vector.Add(vrt1, vtemp1);
                vrt2 = Vector.Add(vrt2, vtemp2);
                p0 = ref Unsafe.Add(ref p0, GroupSize);
        ...
        [Benchmark]
        public void SumBase_ByX2Unzip() {
            if (BenchmarkUtil.IsLastRun) {
                //Debugger.Break();
                Volatile.Write(ref dstTMy, 0);
            }
            dstTMy = StaticSumBase_ByX2Unzip(srcArray, srcArray.Length);
            CheckResult("SumBase_ByX2Unzip");
        }
        ...
        /// <summary>
        /// Sum YGroup3ZipX2 - Vector - base - Unzip.
        /// </summary>
        /// <param name="src">Source array.</param>
        /// <param name="srcCount">Source count</param>
        /// <returns>Returns the sum.</returns>
        private static TMy StaticSumX2Base_Unzip(TMy[] src, int srcCount) {
            TMy rt = 0; // Result.
            const int GroupSize = 2;
            int VectorWidth = Vector<TMy>.Count; // Block width.
            int nBlockWidth = VectorWidth * GroupSize; // Block width.
            ...
            for (i = 0; i < cntBlock; ++i) {
                Vector<TMy> data3 = Unsafe.Add(ref p0, 1);
                Vector<TMy> vtemp = VectorTraitsBase.Statics.YGroup3ZipX2_Unzip(p0, vector1Used, vector2Used, data3, vector4Used, vector5Used, out var vtemp1, out var vtemp2, out var vtemp3, out var vtemp4, out var vtemp5);
                vrt = Vector.Add(vrt, vtemp);
                vrt1 = Vector.Add(vrt1, vtemp1);
                vrt2 = Vector.Add(vrt2, vtemp2);
                vrt3 = Vector.Add(vrt3, vtemp3);
        ...
        [Benchmark]
        public void SumX2Base_Unzip() {
            if (BenchmarkUtil.IsLastRun) {
                //Debugger.Break();
                Volatile.Write(ref dstTMy, 0);
            }
            dstTMy = StaticSumX2Base_Unzip(srcArray, srcArray.Length);
            CheckResult("SumX2Base_Unzip");
        }
        ...
        /// <summary>
        /// Sum YGroup3Zip - Vector128 - base - ByX2Unzip.
        /// </summary>
        /// <param name="src">Source array.</param>
        /// <param name="srcCount">Source count</param>
        /// <returns>Returns the sum.</returns>
        private static TMy StaticSum128Base_ByX2Unzip(TMy[] src, int srcCount) {
            TMy rt = 0; // Result.
            const int GroupSize = 1;
            int VectorWidth = Vector128<TMy>.Count; // Block width.
            int nBlockWidth = VectorWidth * GroupSize; // Block width.
            ...
            // a) Vector processs.
            for (i = 0; i < cntBlock; ++i) {
                Vector128<TMy> vtemp = WVectorTraits128Base.Statics.YGroup3Zip_ByX2Unzip(p0, vector1Used, vector2Used, out var vtemp1, out var vtemp2);
                vrt = WVectorTraits128Base.Statics.Add(vrt, vtemp);
                vrt1 = WVectorTraits128Base.Statics.Add(vrt1, vtemp1);
                vrt2 = WVectorTraits128Base.Statics.Add(vrt2, vtemp2);
                p0 = ref Unsafe.Add(ref p0, GroupSize);
        ...
        [Benchmark]
        public void Sum128Base_ByX2Unzip() {
            if (BenchmarkUtil.IsLastRun) {
                //Debugger.Break();
                Volatile.Write(ref dstTMy, 0);
            }
            dstOn128 = StaticSum128Base_ByX2Unzip(srcArray, srcArray.Length);
            CheckResult128("Sum128Base_ByX2Unzip");
        }
        ...
        /// <summary>
        /// Sum YGroup3ZipX2 - Vector128 - base - Unzip.
        /// </summary>
        /// <param name="src">Source array.</param>
        /// <param name="srcCount">Source count</param>
        /// <returns>Returns the sum.</returns>
        private static TMy StaticSum128X2Base_Unzip(TMy[] src, int srcCount) {
            TMy rt = 0; // Result.
            const int GroupSize = 2;
            int VectorWidth = Vector128<TMy>.Count; // Block width.
            int nBlockWidth = VectorWidth * GroupSize; // Block width.
            ...
            for (i = 0; i < cntBlock; ++i) {
                Vector128<TMy> data3 = Unsafe.Add(ref p0, 1);
                Vector128<TMy> vtemp = WVectorTraits128Base.Statics.YGroup3ZipX2_Unzip(p0, vector1Used, vector2Used, data3, vector4Used, vector5Used, out var vtemp1, out var vtemp2, out var vtemp3, out var vtemp4, out var vtemp5);
                vrt = WVectorTraits128Base.Statics.Add(vrt, vtemp);
                vrt1 = WVectorTraits128Base.Statics.Add(vrt1, vtemp1);
                vrt2 = WVectorTraits128Base.Statics.Add(vrt2, vtemp2);
                vrt3 = WVectorTraits128Base.Statics.Add(vrt3, vtemp3);
        ...
        [Benchmark]
        public void Sum128X2Base_Unzip() {
            if (BenchmarkUtil.IsLastRun) {
                //Debugger.Break();
                Volatile.Write(ref dstTMy, 0);
            }
            dstOn128 = StaticSum128X2Base_Unzip(srcArray, srcArray.Length);
            CheckResult128("Sum128X2Base_Unzip");
        }
        ...
        /// <summary>
        /// Sum YGroup3Zip - Vector256 - base - ByX2Unzip.
        /// </summary>
        /// <param name="src">Source array.</param>
        /// <param name="srcCount">Source count</param>
        /// <returns>Returns the sum.</returns>
        private static TMy StaticSum256Base_ByX2Unzip(TMy[] src, int srcCount) {
            TMy rt = 0; // Result.
            const int GroupSize = 1;
            int VectorWidth = Vector256<TMy>.Count; // Block width.
            int nBlockWidth = VectorWidth * GroupSize; // Block width.
            ...
            // a) Vector processs.
            for (i = 0; i < cntBlock; ++i) {
                Vector256<TMy> vtemp = WVectorTraits256Base.Statics.YGroup3Zip_ByX2Unzip(p0, vector1Used, vector2Used, out var vtemp1, out var vtemp2);
                vrt = WVectorTraits256Base.Statics.Add(vrt, vtemp);
                vrt1 = WVectorTraits256Base.Statics.Add(vrt1, vtemp1);
                vrt2 = WVectorTraits256Base.Statics.Add(vrt2, vtemp2);
                p0 = ref Unsafe.Add(ref p0, GroupSize);
        ...
        [Benchmark]
        public void Sum256Base_ByX2Unzip() {
            if (BenchmarkUtil.IsLastRun) {
                //Debugger.Break();
                Volatile.Write(ref dstTMy, 0);
            }
            dstOn256 = StaticSum256Base_ByX2Unzip(srcArray, srcArray.Length);
            CheckResult256("Sum256Base_ByX2Unzip");
        }
        ...
        /// <summary>
        /// Sum YGroup3ZipX2 - Vector256 - base - Unzip.
        /// </summary>
        /// <param name="src">Source array.</param>
        /// <param name="srcCount">Source count</param>
        /// <returns>Returns the sum.</returns>
        private static TMy StaticSum256X2Base_Unzip(TMy[] src, int srcCount) {
            TMy rt = 0; // Result.
            const int GroupSize = 2;
            int VectorWidth = Vector256<TMy>.Count; // Block width.
            int nBlockWidth = VectorWidth * GroupSize; // Block width.
            ...
            for (i = 0; i < cntBlock; ++i) {
                Vector256<TMy> data3 = Unsafe.Add(ref p0, 1);
                Vector256<TMy> vtemp = WVectorTraits256Base.Statics.YGroup3ZipX2_Unzip(p0, vector1Used, vector2Used, data3, vector4Used, vector5Used, out var vtemp1, out var vtemp2, out var vtemp3, out var vtemp4, out var vtemp5);
                vrt = WVectorTraits256Base.Statics.Add(vrt, vtemp);
                vrt1 = WVectorTraits256Base.Statics.Add(vrt1, vtemp1);
                vrt2 = WVectorTraits256Base.Statics.Add(vrt2, vtemp2);
                vrt3 = WVectorTraits256Base.Statics.Add(vrt3, vtemp3);
        ...
        [Benchmark]
        public void Sum256X2Base_Unzip() {
            if (BenchmarkUtil.IsLastRun) {
                //Debugger.Break();
                Volatile.Write(ref dstTMy, 0);
            }
            dstOn256 = StaticSum256X2Base_Unzip(srcArray, srcArray.Length);
            CheckResult256("Sum256X2Base_Unzip");
        }
        ...
        /// <summary>
        /// Sum YGroup3Zip - Vector512 - base - ByX2Unzip.
        /// </summary>
        /// <param name="src">Source array.</param>
        /// <param name="srcCount">Source count</param>
        /// <returns>Returns the sum.</returns>
        private static TMy StaticSum512Base_ByX2Unzip(TMy[] src, int srcCount) {
            TMy rt = 0; // Result.
            const int GroupSize = 1;
            int VectorWidth = Vector512<TMy>.Count; // Block width.
            int nBlockWidth = VectorWidth * GroupSize; // Block width.
            ...
            // a) Vector processs.
            for (i = 0; i < cntBlock; ++i) {
                Vector512<TMy> vtemp = WVectorTraits512Base.Statics.YGroup3Zip_ByX2Unzip(p0, vector1Used, vector2Used, out var vtemp1, out var vtemp2);
                vrt = WVectorTraits512Base.Statics.Add(vrt, vtemp);
                vrt1 = WVectorTraits512Base.Statics.Add(vrt1, vtemp1);
                vrt2 = WVectorTraits512Base.Statics.Add(vrt2, vtemp2);
                p0 = ref Unsafe.Add(ref p0, GroupSize);
        ...
        [Benchmark]
        public void Sum512Base_ByX2Unzip() {
            if (BenchmarkUtil.IsLastRun) {
                //Debugger.Break();
                Volatile.Write(ref dstTMy, 0);
            }
            dstOn512 = StaticSum512Base_ByX2Unzip(srcArray, srcArray.Length);
            CheckResult512("Sum512Base_ByX2Unzip");
        }
        ...
        /// <summary>
        /// Sum YGroup3ZipX2 - Vector512 - base - Unzip.
        /// </summary>
        /// <param name="src">Source array.</param>
        /// <param name="srcCount">Source count</param>
        /// <returns>Returns the sum.</returns>
        private static TMy StaticSum512X2Base_Unzip(TMy[] src, int srcCount) {
            TMy rt = 0; // Result.
            const int GroupSize = 2;
            int VectorWidth = Vector512<TMy>.Count; // Block width.
            int nBlockWidth = VectorWidth * GroupSize; // Block width.
            ...
            for (i = 0; i < cntBlock; ++i) {
                Vector512<TMy> data3 = Unsafe.Add(ref p0, 1);
                Vector512<TMy> vtemp = WVectorTraits512Base.Statics.YGroup3ZipX2_Unzip(p0, vector1Used, vector2Used, data3, vector4Used, vector5Used, out var vtemp1, out var vtemp2, out var vtemp3, out var vtemp4, out var vtemp5);
                vrt = WVectorTraits512Base.Statics.Add(vrt, vtemp);
                vrt1 = WVectorTraits512Base.Statics.Add(vrt1, vtemp1);
                vrt2 = WVectorTraits512Base.Statics.Add(vrt2, vtemp2);
                vrt3 = WVectorTraits512Base.Statics.Add(vrt3, vtemp3);
        ...
        [Benchmark]
        public void Sum512X2Base_Unzip() {
            if (BenchmarkUtil.IsLastRun) {
                //Debugger.Break();
                Volatile.Write(ref dstTMy, 0);
            }
            dstOn512 = StaticSum512X2Base_Unzip(srcArray, srcArray.Length);
            CheckResult512("Sum512X2Base_Unzip");
        }
