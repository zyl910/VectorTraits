...
namespace Zyl.VectorTraits.Benchmarks.AVector.YG {
    ...
    /// <summary>
    /// YGroup3ToGroup4 benchmark - Int64.
    /// </summary>
#if NETCOREAPP3_0_OR_GREATER && DRY_JOB
    [DryJob]
#endif // NETCOREAPP3_0_OR_GREATER && DRY_JOB
    public partial class YGroup3ToGroup4Benchmark_Int64 : AbstractSharedBenchmark_Int64 {
        ...
        /// <summary>
        /// Sum YGroup3ToGroup4 - Vector128 - base - Move.
        /// </summary>
        /// <param name="src">Source array.</param>
        /// <param name="srcCount">Source count</param>
        /// <returns>Returns the sum.</returns>
        private static TMy StaticSum128Base_Move(TMy[] src, int srcCount) {
            ...
            // a) Vector processs.
            for (i = 0; i < cntBlock; ++i) {
                Vector128<TMy> vtemp = WVectorTraits128Base.Statics.YGroup3ToGroup4_Move(p0, vector1Used, vector2Used, out var vtemp1, out var vtemp2, out var vtemp3);
                vrt = WVectorTraits128Base.Statics.Add(vrt, vtemp);
                vrt1 = WVectorTraits128Base.Statics.Add(vrt1, vtemp1);
                vrt2 = WVectorTraits128Base.Statics.Add(vrt2, vtemp2);
                vrt3 = WVectorTraits128Base.Statics.Add(vrt3, vtemp3);
