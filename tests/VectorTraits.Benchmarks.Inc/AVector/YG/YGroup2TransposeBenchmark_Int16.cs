...
namespace Zyl.VectorTraits.Benchmarks.AVector.YG {
    ...
    /// <summary>
    /// YGroup2Transpose benchmark - Int16.
    /// </summary>
#if NETCOREAPP3_0_OR_GREATER && DRY_JOB
    [DryJob]
#endif // NETCOREAPP3_0_OR_GREATER && DRY_JOB
    public partial class YGroup2TransposeBenchmark_Int16 : AbstractSharedBenchmark_Int16 {
        ...
        public void Sum128Base_Shift() {
            ...
            if (CheckMode) {
                baselineOn128 = dstOn128;
                BenchmarkUtil.WriteItem("# Sum128Base_Shift", string.Format("{0}", baselineOn128));
            }
        }
        ...
        public void Sum256Base_Shift() {
            ...
            if (CheckMode) {
                baselineOn256 = dstOn256;
                BenchmarkUtil.WriteItem("# Sum256Base_Shift", string.Format("{0}", baselineOn256));
            }
        }
        ...
        public void Sum512Base_Shift() {
            ...
            if (CheckMode) {
                baselineOn512 = dstOn512;
                BenchmarkUtil.WriteItem("# Sum512Base_Shift", string.Format("{0}", baselineOn512));
            }
        }
