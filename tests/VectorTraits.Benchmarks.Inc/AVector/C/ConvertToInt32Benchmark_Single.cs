...
namespace Zyl.VectorTraits.Benchmarks.AVector.C {
    ...
    public partial class ConvertToInt32Benchmark_Single : AbstractSharedBenchmark {
        ...
        public static TMyOut StaticSum512Bcl(TMy[] src, int srcCount) {
            ...
            // a) Vector processs.
            for (i = 0; i < cntBlock; ++i) {
                vtemp = Vector512.ConvertToInt32(p0);
        ...
        public static TMyOut StaticSum512Base(TMy[] src, int srcCount) {
            ...
            // a) Vector processs.
            for (i = 0; i < cntBlock; ++i) {
                vtemp = WVectorTraits512Base.Statics.ConvertToInt32(p0);
                vrt = Vector512s.Add(vrt, vtemp);
                p0 = ref Unsafe.Add(ref p0, 1);
            }
            // b) Remainder processs.
        ...
        /// <summary>
        /// Sum ConvertToInt32 - 512 - Traits static.
        /// </summary>
        /// <param name="src">Source array.</param>
        /// <param name="srcCount">Source count</param>
        /// <returns>Returns the sum.</returns>
        public static TMyOut StaticSum512Traits(TMy[] src, int srcCount) {
            ...
            // a) Vector processs.
            for (i = 0; i < cntBlock; ++i) {
                vtemp = Vector512s.ConvertToInt32(p0);
                vrt = Vector512s.Add(vrt, vtemp);
                p0 = ref Unsafe.Add(ref p0, 1);
            }
            // b) Remainder processs.
