...
namespace Zyl.VectorTraits.Benchmarks.AVector.YR {
    ...
    /// <summary>
    /// Ceiling benchmark - Double.
    /// </summary>
#if NETCOREAPP3_0_OR_GREATER && DRY_JOB
    [DryJob]
#endif // NETCOREAPP3_0_OR_GREATER && DRY_JOB
    public partial class CeilingBenchmark_Double : AbstractSharedBenchmark {
        ...
        public static TMy StaticSumBase_Basic(TMy[] src, int srcCount) {
            ...
            // a) Vector processs.
            for (i = 0; i < cntBlock; ++i) {
                vtemp = VectorTraitsBase.Statics.Ceiling_Basic(p0);
                vrt += vtemp;
                p0 = ref Unsafe.Add(ref p0, 1);
            }
            // b) Remainder processs.
