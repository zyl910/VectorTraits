...
namespace Zyl.VectorTraits.Benchmarks.AVector.C {
    ...
    public partial class ConvertToUInt32Benchmark_Single : AbstractSharedBenchmark {
        ...
        /// <summary>
        /// Sum ConvertToUInt32 - 256 - Avx2 - ShiftVar.
        /// </summary>
        /// <param name="src">Source array.</param>
        /// <param name="srcCount">Source count</param>
        /// <returns>Returns the sum.</returns>
        public static TMyOut StaticSum256Avx2_ShiftVar(TMy[] src, int srcCount) {
            ...
            // a) Vector processs.
            for (i = 0; i < cntBlock; ++i) {
                vtemp = WVectorTraits256Avx2.Statics.ConvertToUInt32_ShiftVar(p0);
                vrt = Vector256s.Add(vrt, vtemp);
                p0 = ref Unsafe.Add(ref p0, 1);
            }
            // b) Remainder processs.
        ...
        public static TMyOut StaticSum512Bcl(TMy[] src, int srcCount) {
            ...
            // a) Vector processs.
            for (i = 0; i < cntBlock; ++i) {
                vtemp = Vector512.ConvertToUInt32(p0);
        ...
        public static TMyOut StaticSum512Base(TMy[] src, int srcCount) {
            ...
            // a) Vector processs.
            for (i = 0; i < cntBlock; ++i) {
                vtemp = WVectorTraits512Base.Statics.ConvertToUInt32(p0);
                vrt = Vector512s.Add(vrt, vtemp);
                p0 = ref Unsafe.Add(ref p0, 1);
            }
            // b) Remainder processs.
        ...
        /// <summary>
        /// Sum ConvertToUInt32 - 512 - Traits static.
        /// </summary>
        /// <param name="src">Source array.</param>
        /// <param name="srcCount">Source count</param>
        /// <returns>Returns the sum.</returns>
        public static TMyOut StaticSum512Traits(TMy[] src, int srcCount) {
            ...
            // a) Vector processs.
            for (i = 0; i < cntBlock; ++i) {
                vtemp = Vector512s.ConvertToUInt32(p0);
                vrt = Vector512s.Add(vrt, vtemp);
                p0 = ref Unsafe.Add(ref p0, 1);
            }
            // b) Remainder processs.
