...
namespace Zyl.VectorTraits.Benchmarks.AVector.YN {
    ...
    /// <summary>
    /// YNarrowSaturateUnsigned benchmark - Int64.
    /// </summary>
#if NETCOREAPP3_0_OR_GREATER && DRY_JOB
    [DryJob]
#endif // NETCOREAPP3_0_OR_GREATER && DRY_JOB
    public partial class YNarrowSaturateUnsignedBenchmark_Int64 : AbstractSharedBenchmark_Int64_UInt32 {
        ...
        public static TMyOut StaticSumNarrowVector512_Clamp(TMy[] src, int srcCount) {
            ...
            // a) Vector processs.
            for (i = 0; i < cntBlock; ++i) {
                var t = WVectorTraits512Avx512.Statics.YNarrowSaturateUnsigned_Clamp(p0, Unsafe.Add(ref p0, 1));
                vrt = Vector512.Add(vrt, t);
                p0 = ref Unsafe.Add(ref p0, GroupSize);
            }
            // b) Remainder processs.
