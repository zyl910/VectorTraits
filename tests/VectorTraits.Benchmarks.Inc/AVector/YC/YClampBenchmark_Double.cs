...
namespace Zyl.VectorTraits.Benchmarks.AVector.YC {
    ...
    /// <summary>
    /// YClamp benchmark - Double.
    /// </summary>
#if NETCOREAPP3_0_OR_GREATER && DRY_JOB
    [DryJob]
#endif // NETCOREAPP3_0_OR_GREATER && DRY_JOB
    public partial class YClampBenchmark_Double : AbstractSharedBenchmark_Double {

        // -- var --
        private const TMy valueMin = 0.2;
        private const TMy valueMax = 0.8;
