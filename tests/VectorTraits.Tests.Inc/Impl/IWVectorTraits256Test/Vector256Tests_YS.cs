...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        public void YShuffleX3Test<T, TIdx>(T src, TIdx srcIndex) where T : struct where TIdx : struct {
            ...
            Vector256<TIdx>[] indicesList = {
                Vector256s<TIdx>.Serial,
                Vector256s<TIdx>.SerialDesc,
                Vector256s.CreateByDoubleLoop<TIdx>(0, 3),
                Vector256s.CreateByDoubleLoop<TIdx>(1, 3),
                Vector256s.CreateByDoubleLoop<TIdx>(Scalars.GetDoubleFrom(src), 3),
                Vector256s.CreateByDoubleLoop<TIdx>(Scalars.GetDoubleFrom(src) + Vector256<TIdx>.Count, 3),
                Vector256s.CreateByDoubleLoop<TIdx>(Scalars.GetDoubleFrom(src) + Vector256<TIdx>.Count*2, 3),
            };
            foreach (Vector256<T> vector in samples) {
                Vector256<T> vector1 = Vector256s<T>.SerialNegative;
                ...
                foreach (Vector256<TIdx> indices in indicesList) {
                    Vector256<T> expected = Vector256s.YShuffleX3((dynamic)vector, (dynamic)vector1, (dynamic)vector2, (dynamic)indices);
                    if (allowLog) {
                        Console.WriteLine(VectorTextUtil.Format("Indices:\t{0}", indices));
                        Console.WriteLine(VectorTextUtil.Format("Expected:\t{0}", expected));
                    }
                    ...
                    Vector256<TIdx> args0, args1, args2, args3, args4;
#pragma warning disable CS0618 // Type or member is obsolete
                    Vector256s.YShuffleX3_Args<TIdx>(indices, out args0, out args1, out args2, out args3, out args4);
#pragma warning restore CS0618 // Type or member is obsolete
                    Vector256<T> dst = Vector256s.YShuffleX3_Core((dynamic)vector, (dynamic)vector1, (dynamic)vector2, (dynamic)args0, (dynamic)args1, (dynamic)args2, (dynamic)args3, (dynamic)args4);
                    if (allowLogItem) {
                        // Compatible floating-point NaN.
                        Console.WriteLine(VectorTextUtil.Format("{0}:\t{1}, vector={2}, indices={3}", "_Core0", dst, vector, indices));
                    } else {
                    ...
                    // Static: Args and Core with ValueTuple
                    var args = Vector256s.YShuffleX3_Args((dynamic)indices);
                    dst = Vector256s.YShuffleX3_Core((dynamic)vector, (dynamic)vector1, (dynamic)vector2, (dynamic)args);
                    if (allowLogItem) {
                        // Compatible floating-point NaN.
                        Console.WriteLine(VectorTextUtil.Format("{0}:\t{1}, vector={2}, indices={3}", "_Core", dst, vector, indices));
                    } else {
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        public void YShuffleX3InsertTest<T, TIdx>(T src, TIdx srcIndex) where T : struct where TIdx : struct {
            ...
            foreach (Vector256<T> vector in samples) {
                ...
                foreach (Vector256<TIdx> indices in indicesList) {
                    Vector256<T> expected = Vector256s.YShuffleX3Insert((dynamic)back, (dynamic)vector, (dynamic)vector1, (dynamic)vector2, (dynamic)indices);
                    if (allowLog) {
                        Console.WriteLine(VectorTextUtil.Format("Indices:\t{0}", indices));
                        Console.WriteLine(VectorTextUtil.Format("Expected:\t{0}", expected));
                    }
                    ...
                    Vector256<TIdx> args0, args1, args2, args3, args4;
#pragma warning disable CS0618 // Type or member is obsolete
                    Vector256s.YShuffleX3Insert_Args<TIdx>(indices, out args0, out args1, out args2, out args3, out args4);
#pragma warning restore CS0618 // Type or member is obsolete
                    Vector256<T> dst = Vector256s.YShuffleX3Insert_Core((dynamic)back, (dynamic)vector, (dynamic)vector1, (dynamic)vector2, (dynamic)args0, (dynamic)args1, (dynamic)args2, (dynamic)args3, (dynamic)args4);
                    if (allowLogItem) {
                        // Compatible floating-point NaN.
                        Console.WriteLine(VectorTextUtil.Format("{0}:\t{1}, vector={2}, indices={3}", "_Core0", dst, vector, indices));
                    } else {
                    ...
                    // Static: Args and Core with ValueTuple
                    var args = Vector256s.YShuffleX3Insert_Args((dynamic)indices);
                    dst = Vector256s.YShuffleX3Insert_Core((dynamic)back, (dynamic)vector, (dynamic)vector1, (dynamic)vector2, (dynamic)args);
                    if (allowLogItem) {
                        // Compatible floating-point NaN.
                        Console.WriteLine(VectorTextUtil.Format("{0}:\t{1}, vector={2}, indices={3}", "_Core", dst, vector, indices));
                    } else {
...
#pragma warning disable CS0618 // Type or member is obsolete
                        ...
                        // dst = instance.YShuffleX3Insert_Core((dynamic)vector, (dynamic)argsI); // CS1973	'IWVectorTraits256' has no applicable method named 'YShuffleX3Insert_Core' but appears to have an extension method by that name. Extension methods cannot be dynamically dispatched. Consider casting the dynamic arguments or calling the extension method without the extension method syntax.
        ...
        public void YShuffleX3KernelTest<T, TIdx>(T src, TIdx srcIndex) where T : struct where TIdx : struct {
            ...
            foreach (Vector256<T> vector in samples) {
                ...
                foreach (Vector256<TIdx> indicesFor in indicesList) {
                    ...
                    Vector256<TIdx> indicesMask = Vector256s.GreaterThan_Unsigned((dynamic)Vector256s.CreateByDouble<TIdx>(Vector256<TIdx>.Count * 3), (dynamic)indices);
                    indices = Vector256s.BitwiseAnd(indices, indicesMask);
                    ...
                    Vector256<TIdx> args0, args1, args2, args3;
#pragma warning disable CS0618 // Type or member is obsolete
                    Vector256s.YShuffleX3Kernel_Args<TIdx>(indices, out args0, out args1, out args2, out args3);
#pragma warning restore CS0618 // Type or member is obsolete
                    Vector256<T> dst = Vector256s.YShuffleX3Kernel_Core((dynamic)vector, (dynamic)vector1, (dynamic)vector2, (dynamic)args0, (dynamic)args1, (dynamic)args2, (dynamic)args3);
                    if (allowLogItem) {
                        // Compatible floating-point NaN.
                        Console.WriteLine(VectorTextUtil.Format("{0}:\t{1}, vector={2}, indices={3}", "_Core0", dst, vector, indices));
                    } else {
                    ...
                    // Static: Args and Core with ValueTuple
                    var args = Vector256s.YShuffleX3Kernel_Args((dynamic)indices);
                    dst = Vector256s.YShuffleX3Kernel_Core((dynamic)vector, (dynamic)vector1, (dynamic)vector2, (dynamic)args);
                    if (allowLogItem) {
                        // Compatible floating-point NaN.
                        Console.WriteLine(VectorTextUtil.Format("{0}:\t{1}, vector={2}, indices={3}", "_Core", dst, vector, indices));
                    } else {
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        public void YShuffleX4Test<T, TIdx>(T src, TIdx srcIndex) where T : struct where TIdx : struct {
            ...
            foreach (Vector256<T> vector in samples) {
                ...
                foreach (Vector256<TIdx> indices in indicesList) {
                    Vector256<T> expected = Vector256s.YShuffleX4((dynamic)vector, (dynamic)vector1, (dynamic)vector2, (dynamic)vector3, (dynamic)indices);
                    if (allowLog) {
                        Console.WriteLine(VectorTextUtil.Format("Indices:\t{0}", indices));
                        Console.WriteLine(VectorTextUtil.Format("Expected:\t{0}", expected));
                    }
                    ...
                    Vector256<TIdx> args0, args1, args2, args3, args4;
#pragma warning disable CS0618 // Type or member is obsolete
                    Vector256s.YShuffleX4_Args<TIdx>(indices, out args0, out args1, out args2, out args3, out args4);
#pragma warning restore CS0618 // Type or member is obsolete
                    Vector256<T> dst = Vector256s.YShuffleX4_Core((dynamic)vector, (dynamic)vector1, (dynamic)vector2, (dynamic)vector3, (dynamic)args0, (dynamic)args1, (dynamic)args2, (dynamic)args3, (dynamic)args4);
                    if (allowLogItem) {
                        // Compatible floating-point NaN.
                        Console.WriteLine(VectorTextUtil.Format("{0}:\t{1}, vector={2}, indices={3}", "_Core0", dst, vector, indices));
                    } else {
                    ...
                    // Static: Args and Core with ValueTuple
                    var args = Vector256s.YShuffleX4_Args((dynamic)indices);
                    dst = Vector256s.YShuffleX4_Core((dynamic)vector, (dynamic)vector1, (dynamic)vector2, (dynamic)vector3, (dynamic)args);
                    if (allowLogItem) {
                        // Compatible floating-point NaN.
                        Console.WriteLine(VectorTextUtil.Format("{0}:\t{1}, vector={2}, indices={3}", "_Core", dst, vector, indices));
                    } else {
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        public void YShuffleX4InsertTest<T, TIdx>(T src, TIdx srcIndex) where T : struct where TIdx : struct {
            ...
            foreach (Vector256<T> vector in samples) {
                ...
                foreach (Vector256<TIdx> indices in indicesList) {
                    Vector256<T> expected = Vector256s.YShuffleX4Insert((dynamic)back, (dynamic)vector, (dynamic)vector1, (dynamic)vector2, (dynamic)vector3, (dynamic)indices);
                    if (allowLog) {
                        Console.WriteLine(VectorTextUtil.Format("Indices:\t{0}", indices));
                        Console.WriteLine(VectorTextUtil.Format("Expected:\t{0}", expected));
                    }
                    ...
                    Vector256<TIdx> args0, args1, args2, args3, args4;
#pragma warning disable CS0618 // Type or member is obsolete
                    Vector256s.YShuffleX4Insert_Args<TIdx>(indices, out args0, out args1, out args2, out args3, out args4);
#pragma warning restore CS0618 // Type or member is obsolete
                    Vector256<T> dst = Vector256s.YShuffleX4Insert_Core((dynamic)back, (dynamic)vector, (dynamic)vector1, (dynamic)vector2, (dynamic)vector3, (dynamic)args0, (dynamic)args1, (dynamic)args2, (dynamic)args3, (dynamic)args4);
                    if (allowLogItem) {
                        // Compatible floating-point NaN.
                        Console.WriteLine(VectorTextUtil.Format("{0}:\t{1}, vector={2}, indices={3}", "_Core0", dst, vector, indices));
                    } else {
                    ...
                    // Static: Args and Core with ValueTuple
                    var args = Vector256s.YShuffleX4Insert_Args((dynamic)indices);
                    dst = Vector256s.YShuffleX4Insert_Core((dynamic)back, (dynamic)vector, (dynamic)vector1, (dynamic)vector2, (dynamic)vector3, (dynamic)args);
                    if (allowLogItem) {
                        // Compatible floating-point NaN.
                        Console.WriteLine(VectorTextUtil.Format("{0}:\t{1}, vector={2}, indices={3}", "_Core", dst, vector, indices));
                    } else {
...
#pragma warning disable CS0618 // Type or member is obsolete
                        ...
                        // dst = instance.YShuffleX4Insert_Core((dynamic)vector, (dynamic)argsI); // CS1973	'IWVectorTraits256' has no applicable method named 'YShuffleX4Insert_Core' but appears to have an extension method by that name. Extension methods cannot be dynamically dispatched. Consider casting the dynamic arguments or calling the extension method without the extension method syntax.
