...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        public void YGroup3ToGroup4Test<T>(T src) where T : struct {
            ...
            var funcList = Vector256s.GetSupportedMethodList<FuncIn3Out3<Vector256<T>>>("YGroup3ToGroup4_Basic", "YGroup3ToGroup4_Move", "YGroup3ToGroup4_Shuffle", "YGroup3ToGroup4_ShuffleX", "YGroup3ToGroup4_ShuffleXImm", "YGroup3ToGroup4_Unzip");
            foreach (var func in funcList) {
                writer.WriteLine("{0}: OK", ReflectionUtil.GetShortNameWithType(func.Method));
            }
            if (!MyTestUtil.AllowDelegateOut) funcList.Clear();
