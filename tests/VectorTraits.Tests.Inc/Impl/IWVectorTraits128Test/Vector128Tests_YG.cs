...
namespace Zyl.VectorTraits.Tests.Impl.IWVectorTraits128Test {
    ...
    public class Vector128Tests_YG {
        ...
        public void YGroup2UnzipTest<T>(T src) where T : struct {
            ...
            var funcList = Vector128s.GetSupportedMethodList<FuncIn2Out1<Vector128<T>>>("YGroup2Unzip_Basic", "YGroup2Unzip_Narrow", "YGroup2Unzip_Permute", "YGroup2Unzip_Unpack");
        ...
        public void YGroup2Unzip_Int128Test<T>(T src) where T : struct {
            ...
            for (int i = 0; i < samples.Length; i++) {
                ...
                for (int j = 0; j < samples.Length; j++) {
                    ...
                    Vector128<T> dst0, dst1;
#pragma warning disable CS0618 // Type or member is obsolete
                    Vector128<T> expected0 = Vector128s.YGroup2Unzip_Int128(data0, data1, out Vector128<T> expected1);
                    if (allowLog && 0 == i && 1 == j) {
                        writer.WriteLine(VectorTextUtil.Format("f({0}, {1}): {2}, {3}", data0, data1, expected0, expected1));
                    }
                    foreach (IWVectorTraits128 instance in instances) {
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        public void YGroup2ZipTest<T>(T src) where T : struct {
            ...
            var funcList = Vector128s.GetSupportedMethodList<FuncIn2Out1<Vector128<T>>>("YGroup2Zip_Basic", "YGroup2Zip_Permute", "YGroup2Zip_Unpack", "YGroup2Zip_Widen");
            foreach (var func in funcList) {
                writer.WriteLine("{0}: OK", ReflectionUtil.GetShortNameWithType(func.Method));
            }
            bool[] funcListUnsupported = new bool[funcList.Count];
        ...
        public void YGroup2Zip_Int128Test<T>(T src) where T : struct {
            ...
            for (int i = 0; i < samples.Length; i++) {
                ...
                for (int j = 0; j < samples.Length; j++) {
                    ...
                    Vector128<T> dst0, dst1;
#pragma warning disable CS0618 // Type or member is obsolete
                    Vector128<T> expected0 = Vector128s.YGroup2Zip_Int128(x, y, out Vector128<T> expected1);
                    if (allowLog && 0 == i && 1 == j) {
                        writer.WriteLine(VectorTextUtil.Format("f({0}, {1}): {2}, {3}", x, y, expected0, expected1));
                    }
                    foreach (IWVectorTraits128 instance in instances) {
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        public void YGroup4UnzipTest<T>(T src) where T : struct {
            ...
            var funcList = Vector128s.GetSupportedMethodList<FuncIn4Out3<Vector128<T>>>("YGroup4Unzip_Basic", "YGroup4Unzip_Move", "YGroup4Unzip_Narrow", "YGroup4Unzip_Permute", "YGroup4Unzip_PermuteLonger", "YGroup4Unzip_Unpack", "YGroup4Unzip_Unzip");
            foreach (var func in funcList) {
                writer.WriteLine("{0}: OK", ReflectionUtil.GetShortNameWithType(func.Method));
            }
            bool[] funcListUnsupported = new bool[funcList.Count];
        ...
        public void YGroup4Unzip_Int128Test<T>(T src) where T : struct {
            ...
            for (int i = 0; i < samples.Length; i++) {
                ...
                for (int j = 0; j < samples.Length; j++) {
                    ...
                    Vector128<T> dst0, dst1, dst2, dst3;
#pragma warning disable CS0618 // Type or member is obsolete
                    Vector128<T> expected0 = Vector128s.YGroup4Unzip_Int128(data0, data1, data2, data3, out Vector128<T> expected1, out Vector128<T> expected2, out Vector128<T> expected3);
                    if (allowLog && 0 == i && 1 == j) {
                        writer.WriteLine(VectorTextUtil.Format("f({0}, {1}, {2}, {3}): {4}, {5}, {6}, {7}", data0, data1, data2, data3, expected0, expected1, expected2, expected3));
                    }
                    foreach (IWVectorTraits128 instance in instances) {
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        public void YGroup4ZipTest<T>(T src) where T : struct {
            ...
            var funcList = Vector128s.GetSupportedMethodList<FuncIn4Out3<Vector128<T>>>("YGroup4Zip_Basic", "YGroup4Zip_Move", "YGroup4Zip_Narrow", "YGroup4Zip_Permute", "YGroup4Zip_PermuteLonger", "YGroup4Zip_Unpack", "YGroup4Zip_Unzip");
            foreach (var func in funcList) {
                writer.WriteLine("{0}: OK", ReflectionUtil.GetShortNameWithType(func.Method));
            }
            bool[] funcListUnsupported = new bool[funcList.Count];
        ...
        public void YGroup4Zip_Int128Test<T>(T src) where T : struct {
            ...
            for (int i = 0; i < samples.Length; i++) {
                ...
                for (int j = 0; j < samples.Length; j++) {
                    ...
                    Vector128<T> dst0, dst1, dst2, dst3;
#pragma warning disable CS0618 // Type or member is obsolete
                    Vector128<T> expected0 = Vector128s.YGroup4Zip_Int128(data0, data1, data2, data3, out Vector128<T> expected1, out Vector128<T> expected2, out Vector128<T> expected3);
                    if (allowLog && 0 == i && 1 == j) {
                        writer.WriteLine(VectorTextUtil.Format("f({0}, {1}, {2}, {3}): {4}, {5}, {6}, {7}", data0, data1, data2, data3, expected0, expected1, expected2, expected3));
                    }
                    foreach (IWVectorTraits128 instance in instances) {
