...
namespace Zyl.VectorTraits.Tests.Impl.IWVectorTraits256Test {
    ...
    public class Vector256Tests_C {
        ...
        public void ConvertToInt64Test<T>(T src) where T : struct {
            ...
            var funcList = Vector256s.GetSupportedMethodList<Func<Vector256<T>, Vector256<long>>>("ConvertToInt64_HwScalar", "ConvertToInt64_ShiftVar", "ConvertToInt64_ShiftVarFix");
            foreach (var func in funcList) {
                Console.WriteLine("{0}: OK", ReflectionUtil.GetShortNameWithType(func.Method));
            }
            Console.WriteLine();
        ...
        public void ConvertToInt64_Range52Test<T>(T src) where T : struct {
            ...
            var funcList = Vector256s.GetSupportedMethodList<Func<Vector256<T>, Vector256<long>>>("ConvertToInt64_Range52", "ConvertToInt64_Range52_Impl", "ConvertToInt64_Range52RoundToEven");
            foreach (var func in funcList) {
                Console.WriteLine("{0}: OK", ReflectionUtil.GetShortNameWithType(func.Method));
            }
            Console.WriteLine();
        ...
        public void ConvertToUInt64Test<T>(T src) where T : struct {
            ...
            var funcList = Vector256s.GetSupportedMethodList<Func<Vector256<T>, Vector256<ulong>>>("ConvertToUInt64_ShiftVar");
            foreach (var func in funcList) {
                Console.WriteLine("{0}: OK", ReflectionUtil.GetShortNameWithType(func.Method));
            }
            Console.WriteLine();
