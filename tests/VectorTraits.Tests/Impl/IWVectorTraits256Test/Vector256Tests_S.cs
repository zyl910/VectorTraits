        ...
        public void ShiftRightArithmeticTest<T>(T src) where T : struct {
            ...
            foreach (Vector256<T> vsrc in samples) {
                for (int shiftAmount = -1; shiftAmount <= shiftAmountMax; ++shiftAmount) {
                    ...
                    Vector256<T> args0, args1;
#pragma warning disable CS0618 // Type or member is obsolete
                    (args0, args1) = Vector256s.ShiftRightArithmetic_Args<T>(vsrc, shiftAmount);
#pragma warning restore CS0618 // Type or member is obsolete
                    Vector256<T> vdst = Vector256s.ShiftRightArithmetic_Core((dynamic)vsrc, shiftAmount, (dynamic)args0, (dynamic)args1);
                    Assert.AreEqual(vexpected, vdst, $"_Core, shiftAmount={shiftAmount}, vsrc={vsrc}");
                    foreach (IWVectorTraits256 instance in instances) {
                        if (!instance.GetIsSupported(true)) continue;
...
#pragma warning disable CS0618 // Type or member is obsolete
                    (args0, args1) = Vector256s.ShiftRightArithmetic_Args<T>(vsrc, shiftAmount);
#pragma warning restore CS0618 // Type or member is obsolete
                    Vector256<T> vdst = Vector256s.ShiftRightArithmetic_ConstCore((dynamic)vsrc, shiftAmount, (dynamic)args0, (dynamic)args1);
                    Assert.AreEqual(vexpected, vdst, $"_Core, shiftAmount={shiftAmount}, vsrc={vsrc}");
                    // Instances
                    foreach (IWVectorTraits256 instance in instances) {
                        if (!instance.GetIsSupported(true)) continue;
        ...
        public void ShiftRightLogicalTest<T>(T src) where T : struct {
            ...
            foreach (Vector256<T> vsrc in samples) {
                for (int shiftAmount = -1; shiftAmount <= shiftAmountMax; ++shiftAmount) {
                    ...
                    Vector256<T> args0, args1;
#pragma warning disable CS0618 // Type or member is obsolete
                    (args0, args1) = Vector256s.ShiftRightLogical_Args<T>(vsrc, shiftAmount);
#pragma warning restore CS0618 // Type or member is obsolete
                    Vector256<T> vdst = Vector256s.ShiftRightLogical_Core((dynamic)vsrc, shiftAmount, (dynamic)args0, (dynamic)args1);
                    Assert.AreEqual(vexpected, vdst, $"_Core, shiftAmount={shiftAmount}, vsrc={vsrc}");
                    foreach (IWVectorTraits256 instance in instances) {
                        if (!instance.GetIsSupported(true)) continue;
...
#pragma warning disable CS0618 // Type or member is obsolete
                    (args0, args1) = Vector256s.ShiftRightLogical_Args<T>(vsrc, shiftAmount);
#pragma warning restore CS0618 // Type or member is obsolete
                    Vector256<T> vdst = Vector256s.ShiftRightLogical_ConstCore((dynamic)vsrc, shiftAmount, (dynamic)args0, (dynamic)args1);
                    Assert.AreEqual(vexpected, vdst, $"_Core, shiftAmount={shiftAmount}, vsrc={vsrc}");
                    // Instances
                    foreach (IWVectorTraits256 instance in instances) {
                        if (!instance.GetIsSupported(true)) continue;
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        public void SqrtTest<T>(T src) where T : struct {
            ...
            foreach (Vector256<T> vector in samples) {
                Vector256<T> expected = Vector256s.Sqrt((dynamic)vector);
