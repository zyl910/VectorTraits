...
namespace Zyl.VectorTraits {
    ...
    public abstract class Vector128s<T> : AbstractVectors<T> where T : struct {
        ...
        public static readonly Vector128<T> XyAddress0Mask;
        ...
        public static readonly Vector128<T> XyAddress1Mask;
        /// <summary>Xy - Address 0 is normalized number of value 1 (地址0为 值1的归一化数).</summary>
        public static readonly Vector128<T> XyAddress0NormOne;
        /// <summary>Xy - Address 1 is normalized number of value 1 (地址1为 值1的归一化数).</summary>
        public static readonly Vector128<T> XyAddress1NormOne;
        ...
        public static readonly Vector128<T> XyXNormOne;
        /// <summary>Xy - Y is normalized number of value 1 (Y为 值1的归一化数).</summary>
        public static readonly Vector128<T> XyYNormOne;
        // -- Xyzw --
        ...
        public static readonly Vector128<T> XyzwAddress0Mask;
        ...
        public static readonly Vector128<T> XyzwAddress1Mask;
        ...
        public static readonly Vector128<T> XyzwAddress2Mask;
        ...
        static Vector128s() {
            ...
            // -- Specified value --
            IndexMask = Vector128s.CreateByBits<T>(Vector128s.Count<T>() - 1);
            IndexMaskEach128 = Vector128s.CreateByBits<T>((16 / Scalars<T>.ByteSize) - 1);
            IndexX2Mask = Vector128s.CreateByBits<T>(Vector128s.Count<T>() * 2 - 1);
            IndexX4Mask = Vector128s.CreateByBits<T>(Vector128s.Count<T>() * 4 - 1);
            Serial = Vector128s.CreateByDoubleLoop<T>(0, 1);
            SerialDesc = Vector128s.CreateByDoubleLoop<T>(Vector128s.Count<T>() - 1, -1);
            SerialNegative = Vector128s.CreateByDoubleLoop<T>(0, -1);
            Demo = Vector128s.CreateByFunc<T>(Vectors.GenerateDemoElement<T>);
            DemoNaN = Vector128s.CreateRotate<T>(ElementNaN, ElementNegativeInfinity, ElementSignMask, ElementPositiveInfinity, ElementMaxValue, ElementMinValue, ElementV6, ElementV7);
            DemoNaN2 = Vector128s.CreateRotate<T>(ElementPositiveInfinity, ElementNaN, ElementNegativeInfinity, ElementSignMask, ElementV_4, ElementMaxValue, ElementMinValue, ElementV_7);
            ...
            if (true) {
                ...
                T n = ElementNormOne;
                XyAddress0Mask = Vector128s.CreateRotate<T>(f, o);
                XyAddress1Mask = Vector128s.CreateRotate<T>(o, f);
                XyAddress0NormOne = Vector128s.CreateRotate<T>(n, o);
                XyAddress1NormOne = Vector128s.CreateRotate<T>(o, n);
                XyzwAddress0Mask = Vector128s.CreateRotate<T>(f, o, o, o);
                XyzwAddress1Mask = Vector128s.CreateRotate<T>(o, f, o, o);
                XyzwAddress2Mask = Vector128s.CreateRotate<T>(o, o, f, o);
                XyzwAddress3Mask = Vector128s.CreateRotate<T>(o, o, o, f);
                XyzwAddress0NormOne = Vector128s.CreateRotate<T>(n, o, o, o);
                XyzwAddress1NormOne = Vector128s.CreateRotate<T>(o, n, o, o);
                XyzwAddress2NormOne = Vector128s.CreateRotate<T>(o, o, n, o);
                XyzwAddress3NormOne = Vector128s.CreateRotate<T>(o, o, o, n);
            }
        ...
        /// <summary>
        /// Get bits mask span (获取位集掩码的跨度). Tip: You can use <see cref="Unsafe.As{TFrom, TTo}(ref TFrom)"/> convert its item to <see cref="Vector128{T}"/> type (提示: 可以用 <see cref="Unsafe.As{TFrom, TTo}(ref TFrom)"/> 将其中条目转为 <see cref="Vector128{T}"/> 类型).
        /// </summary>
        ...
        /// <seealso cref="Vector128{T}.Zero"/>
        public static Vector128<T> Zero { [MethodImpl(MethodImplOptions.AggressiveInlining)] get { return Vector128<byte>.Zero.ExAs<byte, T>(); } }
        /// <summary>Value 0 (0的值).</summary>
        /// <seealso cref="Vector128{T}.Zero"/>
        public static Vector128<T> V0 { [MethodImpl(MethodImplOptions.AggressiveInlining)] get { return Vector128<byte>.Zero.ExAs<byte, T>(); } }
        /// <summary>All bit is 1 (所有位都是1的值).</summary>
        /// <seealso cref="Vector128{T}.AllBitsSet"/>
...
#else
                return Vector128.Create((int)-1).As<int, T>();
