...
namespace Zyl.VectorTraits {
    ...
    public abstract class Vector512s<T> : AbstractVectors<T> where T : struct {
        ...
        public static readonly Vector512<T> XyAddress0Mask;
        ...
        public static readonly Vector512<T> XyAddress1Mask;
        /// <summary>Xy - Address 0 is normalized number of value 1 (地址0为 值1的归一化数).</summary>
        public static readonly Vector512<T> XyAddress0NormOne;
        /// <summary>Xy - Address 1 is normalized number of value 1 (地址1为 值1的归一化数).</summary>
        public static readonly Vector512<T> XyAddress1NormOne;
        ...
        public static readonly Vector512<T> XyXNormOne;
        /// <summary>Xy - Y is normalized number of value 1 (Y为 值1的归一化数).</summary>
        public static readonly Vector512<T> XyYNormOne;
        // -- Xyzw --
        ...
        public static readonly Vector512<T> XyzwAddress0Mask;
        ...
        public static readonly Vector512<T> XyzwAddress1Mask;
        ...
        public static readonly Vector512<T> XyzwAddress2Mask;
        ...
        static Vector512s() {
            ...
            // -- Specified value --
            IndexMask = Vector512s.CreateByBits<T>(Vector512s.Count<T>() - 1);
            IndexMaskEach128 = Vector512s.CreateByBits<T>((16 / Scalars<T>.ByteSize) - 1);
            IndexX2Mask = Vector512s.CreateByBits<T>(Vector512s.Count<T>() * 2 - 1);
            IndexX4Mask = Vector512s.CreateByBits<T>(Vector512s.Count<T>() * 4 - 1);
            Serial = Vector512s.CreateByDoubleLoop<T>(0, 1);
            SerialDesc = Vector512s.CreateByDoubleLoop<T>(Vector512s.Count<T>() - 1, -1);
            SerialNegative = Vector512s.CreateByDoubleLoop<T>(0, -1);
            Demo = Vector512s.CreateByFunc<T>(Vectors.GenerateDemoElement<T>);
            DemoNaN = Vector512s.CreateRotate<T>(ElementNaN, ElementNegativeInfinity, ElementSignMask, ElementPositiveInfinity, ElementMaxValue, ElementMinValue, ElementV6, ElementV7);
            DemoNaN2 = Vector512s.CreateRotate<T>(ElementPositiveInfinity, ElementNaN, ElementNegativeInfinity, ElementSignMask, ElementV_4, ElementMaxValue, ElementMinValue, ElementV_7);
            ...
            if (true) {
                ...
                T n = ElementNormOne;
                XyAddress0Mask = Vector512s.CreateRotate<T>(f, o);
                XyAddress1Mask = Vector512s.CreateRotate<T>(o, f);
                XyAddress0NormOne = Vector512s.CreateRotate<T>(n, o);
                XyAddress1NormOne = Vector512s.CreateRotate<T>(o, n);
                XyzwAddress0Mask = Vector512s.CreateRotate<T>(f, o, o, o);
                XyzwAddress1Mask = Vector512s.CreateRotate<T>(o, f, o, o);
                XyzwAddress2Mask = Vector512s.CreateRotate<T>(o, o, f, o);
                XyzwAddress3Mask = Vector512s.CreateRotate<T>(o, o, o, f);
                XyzwAddress0NormOne = Vector512s.CreateRotate<T>(n, o, o, o);
                XyzwAddress1NormOne = Vector512s.CreateRotate<T>(o, n, o, o);
                XyzwAddress2NormOne = Vector512s.CreateRotate<T>(o, o, n, o);
                XyzwAddress3NormOne = Vector512s.CreateRotate<T>(o, o, o, n);
            }
        ...
        public static int Count {
            get {
                return Vector512s.Count<T>();
            }
        }

        /// <summary>
        /// Get bit pos mask by index (根据索引获取位偏移掩码). The equivalent of <c>Vector512s.Create(Scalars.GetByBits&lt;T&gt;(1L &lt;&lt; index))</c>.
        /// </summary>
        ...
        public static Vector512<T> GetMaskBitPos(int index) {
            return Unsafe.As<Vector512<byte>, Vector512<T>>(ref MaskBitPosArray[index]);
        }

        /// <summary>
        /// Get bit pos mask span (获取位偏移掩码的跨度). Tip: You can use <see cref="Unsafe.As{TFrom, TTo}(ref TFrom)"/> convert its item to <see cref="Vector512{T}"/> type (提示: 可以用 <see cref="Unsafe.As{TFrom, TTo}(ref TFrom)"/> 将其中条目转为 <see cref="Vector512{T}"/> 类型).
        /// </summary>
        ...
        /// <summary>
        /// Get bits mask by index (根据索引获取位集掩码). The equivalent of <c>Vector512s.Create(Scalars.GetBitsMask&lt;T&gt;(0, index))</c>.
        /// </summary>
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector512<T> GetMaskBits(int index) {
            return Unsafe.As<Vector512<byte>, Vector512<T>>(ref MaskBitsArray[index]);
        }

        /// <summary>
        /// Get bits mask span (获取位集掩码的跨度). Tip: You can use <see cref="Unsafe.As{TFrom, TTo}(ref TFrom)"/> convert its item to <see cref="Vector512{T}"/> type (提示: 可以用 <see cref="Unsafe.As{TFrom, TTo}(ref TFrom)"/> 将其中条目转为 <see cref="Vector512{T}"/> 类型).
        /// </summary>
        ...
        /// <seealso cref="Vector512{T}.Zero"/>
        public static Vector512<T> Zero { [MethodImpl(MethodImplOptions.AggressiveInlining)] get { return Vector512<byte>.Zero.ExAs<byte, T>(); } }
        /// <summary>Value 0 (0的值).</summary>
        /// <seealso cref="Vector512{T}.Zero"/>
        public static Vector512<T> V0 { [MethodImpl(MethodImplOptions.AggressiveInlining)] get { return Vector512<byte>.Zero.ExAs<byte, T>(); } }
        /// <summary>All bit is 1 (所有位都是1的值).</summary>
        /// <seealso cref="Vector512{T}.AllBitsSet"/>
...
#else
                return Vector512.Create((int)-1).As<int, T>();
#endif // NET5_0_OR_GREATER
            }
        }

        /// <summary>1 bits mask (1位掩码).</summary>
        public static Vector512<T> MaskBits1 { [MethodImpl(MethodImplOptions.AggressiveInlining)] get { return GetMaskBits(1); } }
        /// <summary>2 bits mask (2位掩码).</summary>
        public static Vector512<T> MaskBits2 { [MethodImpl(MethodImplOptions.AggressiveInlining)] get { return GetMaskBits(2); } }
        /// <summary>4 bits mask (4位掩码).</summary>
        public static Vector512<T> MaskBits4 { [MethodImpl(MethodImplOptions.AggressiveInlining)] get { return GetMaskBits(4); } }
        /// <summary>8 bits mask (8位掩码).</summary>
        public static Vector512<T> MaskBits8 { [MethodImpl(MethodImplOptions.AggressiveInlining)] get { return GetMaskBits(8); } }
        /// <summary>16 bits mask (16位掩码).</summary>
        public static Vector512<T> MaskBits16 { [MethodImpl(MethodImplOptions.AggressiveInlining)] get { return GetMaskBits(Math.Min(ElementBitSize, 16)); } }
        /// <summary>32 bits mask (32位掩码).</summary>
        public static Vector512<T> MaskBits32 { [MethodImpl(MethodImplOptions.AggressiveInlining)] get { return GetMaskBits(Math.Min(ElementBitSize, 32)); } }
