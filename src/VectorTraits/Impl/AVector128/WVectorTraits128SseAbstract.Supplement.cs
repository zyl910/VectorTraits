...
namespace Zyl.VectorTraits.Impl.AVector128 {
    ...
    partial class WVectorTraits128SseAbstract {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public override Vector128<float> ConditionalSelect(Vector128<int> condition, Vector128<float> left, Vector128<float> right) {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public override Vector128<double> ConditionalSelect(Vector128<long> condition, Vector128<double> left, Vector128<double> right) {
