    ...
    partial class WVectorTraits128AdvSimd {
        ...
        partial class Statics {
            ...
            public static Vector128<int> YIsEvenInteger(Vector128<float> value) {
                Vector128<float> valueHalf = AdvSimd.Multiply(value, Vector128.Create(0.5f));
                ...
                Vector128<int> rt = AdvSimd.And(intMask, halfEqual);
                return rt;
            }
            ...
            public static Vector128<sbyte> YIsEvenInteger(Vector128<sbyte> value) {
                Vector128<sbyte> temp = AdvSimd.And(value, Vector128Constants.Byte_One.AsSByte());
            ...
            public static Vector128<short> YIsEvenInteger(Vector128<short> value) {
                Vector128<short> temp = AdvSimd.And(value, Vector128Constants.Int16_One);
            ...
            public static Vector128<int> YIsEvenInteger(Vector128<int> value) {
                Vector128<int> temp = AdvSimd.And(value, Vector128Constants.Int32_One);
            ...
            public static Vector128<int> YIsFinite(Vector128<float> value) {
                ...
                Vector128<int> exponent = AdvSimd.And(value.AsInt32(), exponentMask);
            ...
            public static Vector128<int> YIsInfinity(Vector128<float> value) {
                ...
                Vector128<int> exponentMask = Vector128Constants.Single_ExponentMask.AsInt32();
                Vector128<int> nonSign = AdvSimd.And(value.AsInt32(), nonSignMask);
            ...
            public static Vector128<int> YIsInteger(Vector128<float> value) {
                ...
                Vector128<int> rt = AdvSimd.And(maskFinite, maskEquals);
                return rt;
            }
            ...
            public static Vector128<short> YIsNegative(Vector128<short> value) {
                ...
                Vector128<short> rt = AdvSimd.ShiftRightArithmetic(value, 15);
                return rt;
            }
            ...
            public static Vector128<int> YIsNegative(Vector128<int> value) {
                ...
                Vector128<int> rt = AdvSimd.ShiftRightArithmetic(value, 31);
                return rt;
            }
            ...
            public static Vector128<int> YIsNormal(Vector128<float> value) {
                Vector128<int> exponentMask = Vector128Constants.Single_ExponentMask.AsInt32();
                Vector128<int> exponent = AdvSimd.And(value.AsInt32(), exponentMask);
                Vector128<int> rt = AdvSimd.And(GreaterThan(exponent, Vector128<int>.Zero), GreaterThan(exponentMask, exponent));
                return rt;
            }
            ...
            public static Vector128<sbyte> YIsNotEquals(Vector128<sbyte> left, Vector128<sbyte> right) {
                return OnesComplement(AdvSimd.CompareEqual(left, right));
            }
            ...
            public static Vector128<int> YIsSubnormal(Vector128<float> value) {
                ...
                Vector128<int> exponent = AdvSimd.And(value.AsInt32(), exponentMask);
                Vector128<int> mantissa = AdvSimd.And(value.AsInt32(), mantissaMask);
                Vector128<int> rt = AdvSimd.And(Equals(exponent, zero), GreaterThan(mantissa, zero));
                return rt;
            }
