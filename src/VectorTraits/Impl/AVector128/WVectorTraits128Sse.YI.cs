    ...
    partial class WVectorTraits128Sse {
        ...
        partial class Statics {
            ...
            public static Vector128<int> YIsEvenInteger(Vector128<float> value) {
                Vector128<float> valueHalf = Sse.Multiply(value, Vector128.Create(0.5f));
                ...
                Vector128<int> rt = Sse2.And(intMask, halfEqual);
                return rt;
            }
            ...
            public static Vector128<long> YIsEvenInteger(Vector128<double> value) {
                Vector128<double> valueHalf = Sse2.Multiply(value, Vector128.Create(0.5));
                ...
                Vector128<long> rt = Sse2.And(intMask, halfEqual);
                return rt;
            }
            ...
            public static Vector128<sbyte> YIsEvenInteger(Vector128<sbyte> value) {
                Vector128<sbyte> temp = Sse2.And(value, Vector128Constants.Byte_One.AsSByte());
            ...
            public static Vector128<short> YIsEvenInteger(Vector128<short> value) {
                Vector128<short> temp = Sse2.And(value, Vector128Constants.Int16_One);
            ...
            public static Vector128<int> YIsEvenInteger(Vector128<int> value) {
                Vector128<int> temp = Sse2.And(value, Vector128Constants.Int32_One);
            ...
            public static Vector128<long> YIsEvenInteger(Vector128<long> value) {
                Vector128<long> temp = Sse2.And(value, Vector128Constants.Int64_One);
            ...
            public static Vector128<int> YIsFinite(Vector128<float> value) {
                ...
                Vector128<int> exponent = Sse2.And(value.AsInt32(), exponentMask);
            ...
            public static Vector128<long> YIsFinite(Vector128<double> value) {
                ...
                Vector128<long> exponent = Sse2.And(value.AsInt64(), exponentMask);
            ...
            public static Vector128<int> YIsInfinity(Vector128<float> value) {
                ...
                Vector128<int> exponentMask = Vector128Constants.Single_ExponentMask.AsInt32();
                Vector128<int> nonSign = Sse2.And(value.AsInt32(), nonSignMask);
            ...
            public static Vector128<long> YIsInfinity(Vector128<double> value) {
                ...
                Vector128<long> exponentMask = Vector128Constants.Double_ExponentMask.AsInt64();
                Vector128<long> nonSign = Sse2.And(value.AsInt64(), nonSignMask);
            ...
            public static Vector128<int> YIsInteger(Vector128<float> value) {
                ...
                Vector128<int> rt = Sse2.And(maskFinite, maskEquals);
                return rt;
            }
            ...
            public static Vector128<long> YIsInteger(Vector128<double> value) {
                ...
                Vector128<long> rt = Sse2.And(maskFinite, maskEquals);
                return rt;
            }
            ...
            public static Vector128<int> YIsNaN(Vector128<float> value) {
                Vector128<int> rt = Sse.CompareNotEqual(value, value).AsInt32();
                return rt;
            }
            ...
            public static Vector128<long> YIsNaN(Vector128<double> value) {
                Vector128<long> rt = Sse2.CompareNotEqual(value, value).AsInt64();
                return rt;
            }
            ...
            public static Vector128<short> YIsNegative(Vector128<short> value) {
                ...
                Vector128<short> rt = Sse2.ShiftRightArithmetic(value, 15);
                return rt;
            }
            ...
            public static Vector128<int> YIsNegative(Vector128<int> value) {
                ...
                Vector128<int> rt = Sse2.ShiftRightArithmetic(value, 31);
                return rt;
            }
            ...
            public static Vector128<int> YIsNormal(Vector128<float> value) {
                Vector128<int> exponentMask = Vector128Constants.Single_ExponentMask.AsInt32();
                Vector128<int> exponent = Sse2.And(value.AsInt32(), exponentMask);
                Vector128<int> rt = Sse2.And(GreaterThan(exponent, Vector128<int>.Zero), GreaterThan(exponentMask, exponent));
                return rt;
            }
            ...
            public static Vector128<long> YIsNormal(Vector128<double> value) {
                Vector128<long> exponentMask = Vector128Constants.Double_ExponentMask.AsInt64();
                Vector128<long> exponent = Sse2.And(value.AsInt64(), exponentMask);
                Vector128<long> rt = Sse2.And(GreaterThan(exponent, Vector128<long>.Zero), GreaterThan(exponentMask, exponent));
                return rt;
            }
            ...
            public static Vector128<int> YIsSubnormal(Vector128<float> value) {
                ...
                Vector128<int> exponent = Sse2.And(value.AsInt32(), exponentMask);
                Vector128<int> mantissa = Sse2.And(value.AsInt32(), mantissaMask);
                Vector128<int> rt = Sse2.And(Equals(exponent, zero), GreaterThan(mantissa, zero));
                return rt;
            }
            ...
            public static Vector128<long> YIsSubnormal(Vector128<double> value) {
                ...
                Vector128<long> exponent = Sse2.And(value.AsInt64(), exponentMask);
                Vector128<long> mantissa = Sse2.And(value.AsInt64(), mantissaMask);
                Vector128<long> rt = Sse2.And(Equals(exponent, zero), GreaterThan(mantissa, zero));
                return rt;
            }
