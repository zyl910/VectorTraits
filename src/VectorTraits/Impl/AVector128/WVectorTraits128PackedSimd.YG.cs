    ...
    partial class WVectorTraits128PackedSimd {
        ...
        partial class Statics {
            ...
            public static Vector128<byte> YGroup1ToGroup3_Shuffle(Vector128<byte> x, out Vector128<byte> result1, out Vector128<byte> result2) {
                ...
                var a_0 = PackedSimd.Swizzle(x, f0);
                var a_1 = PackedSimd.Swizzle(x, f1);
                var a_2 = PackedSimd.Swizzle(x, f2);
                result1 = a_1;
                result2 = a_2;
                return a_0;
            }
            ...
            public static Vector128<ushort> YGroup1ToGroup3_Shuffle(Vector128<ushort> x, out Vector128<ushort> result1, out Vector128<ushort> result2) {
                ...
                var s0 = x.AsByte();
                var a_0 = PackedSimd.Swizzle(s0, f0).AsUInt16();
                var a_1 = PackedSimd.Swizzle(s0, f1).AsUInt16();
                var a_2 = PackedSimd.Swizzle(s0, f2).AsUInt16();
                result1 = a_1;
                result2 = a_2;
                return a_0;
            }
            ...
            public static Vector128<uint> YGroup1ToGroup3_Shuffle(Vector128<uint> x, out Vector128<uint> result1, out Vector128<uint> result2) {
                ...
                var s0 = x.AsByte();
                var a_0 = PackedSimd.Swizzle(s0, f0).AsUInt32();
                var a_1 = PackedSimd.Swizzle(s0, f1).AsUInt32();
                var a_2 = PackedSimd.Swizzle(s0, f2).AsUInt32();
                result1 = a_1;
                result2 = a_2;
                return a_0;
            }
            ...
            public static Vector128<ulong> YGroup1ToGroup3_Shuffle(Vector128<ulong> x, out Vector128<ulong> result1, out Vector128<ulong> result2) {
                ...
                var s0 = x.AsByte();
                var a_0 = PackedSimd.Swizzle(s0, f0).AsUInt64();
                var a_1 = x;
                var a_2 = PackedSimd.Swizzle(s0, f2).AsUInt64();
                result1 = a_1;
                result2 = a_2;
                return a_0;
            }
            ...
            public static Vector128<byte> YGroup2Transpose_Shift(Vector128<byte> data0, Vector128<byte> data1, out Vector128<byte> result1) {
                ...
                if (BitConverter.IsLittleEndian) {
                    b_1 = PackedSimd.ShiftLeft(a_1, L);
                    b_0 = PackedSimd.ShiftRightLogical(a_0, L);
                    c_0 = PackedSimd.Or(PackedSimd.And(a_0, mask), b_1);
                    c_1 = PackedSimd.Or(PackedSimd.AndNot(a_1, mask), b_0);
                } else {
                    b_1 = PackedSimd.ShiftRightLogical(a_1, L);
                    b_0 = PackedSimd.ShiftLeft(a_0, L);
                    c_0 = PackedSimd.Or(PackedSimd.AndNot(a_0, mask), b_1);
                    c_1 = PackedSimd.Or(PackedSimd.And(a_1, mask), b_0);
                }
                result1 = c_1.AsByte();
                return c_0.AsByte();
            }
            ...
            public static Vector128<byte> YGroup2Transpose_Shuffle(Vector128<byte> data0, Vector128<byte> data1, out Vector128<byte> result1) {
                ...
                var a_0 = PackedSimd.Or(PackedSimd.Swizzle(data0, f0A), PackedSimd.Swizzle(data1, f0B));
                var a_1 = PackedSimd.Or(PackedSimd.Swizzle(data0, f1A), PackedSimd.Swizzle(data1, f1B));
                result1 = a_1;
                return a_0;
            }
            ...
            public static Vector128<ushort> YGroup2Transpose_Shuffle(Vector128<ushort> data0, Vector128<ushort> data1, out Vector128<ushort> result1) {
                ...
                var a_0 = PackedSimd.Or(PackedSimd.Swizzle(data0.AsByte(), f0A), PackedSimd.Swizzle(data1.AsByte(), f0B)).AsUInt16();
                var a_1 = PackedSimd.Or(PackedSimd.Swizzle(data0.AsByte(), f1A), PackedSimd.Swizzle(data1.AsByte(), f1B)).AsUInt16();
                result1 = a_1;
                return a_0;
            }
            ...
            public static Vector128<uint> YGroup2Transpose_Shuffle(Vector128<uint> data0, Vector128<uint> data1, out Vector128<uint> result1) {
                ...
                var a_0 = PackedSimd.Or(PackedSimd.Swizzle(data0.AsByte(), f0A), PackedSimd.Swizzle(data1.AsByte(), f0B)).AsUInt32();
                var a_1 = PackedSimd.Or(PackedSimd.Swizzle(data0.AsByte(), f1A), PackedSimd.Swizzle(data1.AsByte(), f1B)).AsUInt32();
                result1 = a_1;
                return a_0;
            }
            ...
            public static Vector128<ulong> YGroup2Transpose_Shuffle(Vector128<ulong> data0, Vector128<ulong> data1, out Vector128<ulong> result1) {
                ...
                var a_0 = PackedSimd.Or(PackedSimd.Swizzle(data0.AsByte(), f0A), PackedSimd.Swizzle(data1.AsByte(), f0B)).AsUInt64();
                var a_1 = PackedSimd.Or(PackedSimd.Swizzle(data0.AsByte(), f1A), PackedSimd.Swizzle(data1.AsByte(), f1B)).AsUInt64();
                result1 = a_1;
                return a_0;
            }
            ...
            public static Vector128<byte> YGroup2Zip_Shuffle(Vector128<byte> x, Vector128<byte> y, out Vector128<byte> data1) {
                var f0 = Vector128Constants.YGroup2Zip_ShuffleX2_Byte_Data0;
                var f0B = Vector128Constants.YGroup2Zip_ShuffleX2_Byte_Data0_Part1;
                var f1 = Vector128Constants.YGroup2Zip_ShuffleX2_Byte_Data1;
                var f1B = Vector128Constants.YGroup2Zip_ShuffleX2_Byte_Data1_Part1;
                var a0 = PackedSimd.Or(PackedSimd.Swizzle(x, f0), PackedSimd.Swizzle(y, f0B));
                var a1 = PackedSimd.Or(PackedSimd.Swizzle(x, f1), PackedSimd.Swizzle(y, f1B));
                data1 = a1;
                return a0;
            }
            ...
            public static Vector128<ushort> YGroup2Zip_Shuffle(Vector128<ushort> x, Vector128<ushort> y, out Vector128<ushort> data1) {
                var f0 = Vector128Constants.YGroup2Zip_ShuffleX2OnByte_UInt16_Data0;
                var f0B = Vector128Constants.YGroup2Zip_ShuffleX2OnByte_UInt16_Data0_Part1;
                var f1 = Vector128Constants.YGroup2Zip_ShuffleX2OnByte_UInt16_Data1;
                var f1B = Vector128Constants.YGroup2Zip_ShuffleX2OnByte_UInt16_Data1_Part1;
                var a0 = PackedSimd.Or(PackedSimd.Swizzle(x.AsByte(), f0), PackedSimd.Swizzle(y.AsByte(), f0B)).AsUInt16();
                var a1 = PackedSimd.Or(PackedSimd.Swizzle(x.AsByte(), f1), PackedSimd.Swizzle(y.AsByte(), f1B)).AsUInt16();
                data1 = a1;
                return a0;
            }
            ...
            public static Vector128<uint> YGroup2Zip_Shuffle(Vector128<uint> x, Vector128<uint> y, out Vector128<uint> data1) {
                var f0 = Vector128Constants.YGroup2Zip_ShuffleX2OnByte_UInt32_Data0;
                var f0B = Vector128Constants.YGroup2Zip_ShuffleX2OnByte_UInt32_Data0_Part1;
                var f1 = Vector128Constants.YGroup2Zip_ShuffleX2OnByte_UInt32_Data1;
                var f1B = Vector128Constants.YGroup2Zip_ShuffleX2OnByte_UInt32_Data1_Part1;
                var a0 = PackedSimd.Or(PackedSimd.Swizzle(x.AsByte(), f0), PackedSimd.Swizzle(y.AsByte(), f0B)).AsUInt32();
                var a1 = PackedSimd.Or(PackedSimd.Swizzle(x.AsByte(), f1), PackedSimd.Swizzle(y.AsByte(), f1B)).AsUInt32();
                data1 = a1;
                return a0;
            }
            ...
            public static Vector128<ulong> YGroup2Zip_Shuffle(Vector128<ulong> x, Vector128<ulong> y, out Vector128<ulong> data1) {
                var f0 = Vector128Constants.YGroup2Zip_ShuffleX2OnByte_UInt64_Data0;
                var f0B = Vector128Constants.YGroup2Zip_ShuffleX2OnByte_UInt64_Data0_Part1;
                var f1 = Vector128Constants.YGroup2Zip_ShuffleX2OnByte_UInt64_Data1;
                var f1B = Vector128Constants.YGroup2Zip_ShuffleX2OnByte_UInt64_Data1_Part1;
                var a0 = PackedSimd.Or(PackedSimd.Swizzle(x.AsByte(), f0), PackedSimd.Swizzle(y.AsByte(), f0B)).AsUInt64();
                var a1 = PackedSimd.Or(PackedSimd.Swizzle(x.AsByte(), f1), PackedSimd.Swizzle(y.AsByte(), f1B)).AsUInt64();
                data1 = a1;
                return a0;
            }
            ...
            public static Vector128<byte> YGroup2ZipHigh(Vector128<byte> x, Vector128<byte> y) {
                var f1 = Vector128Constants.YGroup2Zip_ShuffleX2_Byte_Data1;
                var f1B = Vector128Constants.YGroup2Zip_ShuffleX2_Byte_Data1_Part1;
                return PackedSimd.Or(PackedSimd.Swizzle(x, f1), PackedSimd.Swizzle(y, f1B));
            }
            ...
            public static Vector128<ushort> YGroup2ZipHigh(Vector128<ushort> x, Vector128<ushort> y) {
                var f1 = Vector128Constants.YGroup2Zip_ShuffleX2OnByte_UInt16_Data1;
                var f1B = Vector128Constants.YGroup2Zip_ShuffleX2OnByte_UInt16_Data1_Part1;
                return PackedSimd.Or(PackedSimd.Swizzle(x.AsByte(), f1), PackedSimd.Swizzle(y.AsByte(), f1B)).AsUInt16();
            }
            ...
            public static Vector128<uint> YGroup2ZipHigh(Vector128<uint> x, Vector128<uint> y) {
                var f1 = Vector128Constants.YGroup2Zip_ShuffleX2OnByte_UInt32_Data1;
                var f1B = Vector128Constants.YGroup2Zip_ShuffleX2OnByte_UInt32_Data1_Part1;
                return PackedSimd.Or(PackedSimd.Swizzle(x.AsByte(), f1), PackedSimd.Swizzle(y.AsByte(), f1B)).AsUInt32();
            }
            ...
            public static Vector128<ulong> YGroup2ZipHigh(Vector128<ulong> x, Vector128<ulong> y) {
                var f1 = Vector128Constants.YGroup2Zip_ShuffleX2OnByte_UInt64_Data1;
                var f1B = Vector128Constants.YGroup2Zip_ShuffleX2OnByte_UInt64_Data1_Part1;
                return PackedSimd.Or(PackedSimd.Swizzle(x.AsByte(), f1), PackedSimd.Swizzle(y.AsByte(), f1B)).AsUInt64();
            }
            ...
            public static Vector128<byte> YGroup2ZipLow(Vector128<byte> x, Vector128<byte> y) {
                var f0 = Vector128Constants.YGroup2Zip_ShuffleX2_Byte_Data0;
                var f0B = Vector128Constants.YGroup2Zip_ShuffleX2_Byte_Data0_Part1;
                return PackedSimd.Or(PackedSimd.Swizzle(x, f0), PackedSimd.Swizzle(y, f0B));
            }
            ...
            public static Vector128<ushort> YGroup2ZipLow(Vector128<ushort> x, Vector128<ushort> y) {
                var f0 = Vector128Constants.YGroup2Zip_ShuffleX2OnByte_UInt16_Data0;
                var f0B = Vector128Constants.YGroup2Zip_ShuffleX2OnByte_UInt16_Data0_Part1;
                return PackedSimd.Or(PackedSimd.Swizzle(x.AsByte(), f0), PackedSimd.Swizzle(y.AsByte(), f0B)).AsUInt16();
            }
            ...
            public static Vector128<uint> YGroup2ZipLow(Vector128<uint> x, Vector128<uint> y) {
                var f0 = Vector128Constants.YGroup2Zip_ShuffleX2OnByte_UInt32_Data0;
                var f0B = Vector128Constants.YGroup2Zip_ShuffleX2OnByte_UInt32_Data0_Part1;
                return PackedSimd.Or(PackedSimd.Swizzle(x.AsByte(), f0), PackedSimd.Swizzle(y.AsByte(), f0B)).AsUInt32();
            }
            ...
            public static Vector128<ulong> YGroup2ZipLow(Vector128<ulong> x, Vector128<ulong> y) {
                var f0 = Vector128Constants.YGroup2Zip_ShuffleX2OnByte_UInt64_Data0;
                var f0B = Vector128Constants.YGroup2Zip_ShuffleX2OnByte_UInt64_Data0_Part1;
                return PackedSimd.Or(PackedSimd.Swizzle(x.AsByte(), f0), PackedSimd.Swizzle(y.AsByte(), f0B)).AsUInt64();
            }
            ...
            public static Vector128<byte> YGroup3ToGroup4_Shuffle(Vector128<byte> data0, Vector128<byte> data1, Vector128<byte> data2, out Vector128<byte> result1, out Vector128<byte> result2, out Vector128<byte> result3) {
                ...
                var a_0 = PackedSimd.And(PackedSimd.Swizzle(data0, f0), maskXYZ);
                var a_1 = PackedSimd.And(PackedSimd.Or(PackedSimd.Swizzle(data0, f1A), PackedSimd.Swizzle(data1, f1B)), maskXYZ);
                var a_2 = PackedSimd.And(PackedSimd.Or(PackedSimd.Swizzle(data1, f2A), PackedSimd.Swizzle(data2, f2B)), maskXYZ);
                var a_3 = PackedSimd.And(PackedSimd.Swizzle(data2, f3), maskXYZ);
                result1 = a_1;
                result2 = a_2;
                result3 = a_3;
                return a_0;
            ...
            public static Vector128<ushort> YGroup3ToGroup4_Shuffle(Vector128<ushort> data0, Vector128<ushort> data1, Vector128<ushort> data2, out Vector128<ushort> result1, out Vector128<ushort> result2, out Vector128<ushort> result3) {
                ...
                var s1 = data1.AsByte();
                var s2 = data2.AsByte();
                var a_0 = PackedSimd.And(PackedSimd.Swizzle(s0, f0).AsUInt16(), maskXYZ);
                var a_1 = PackedSimd.And(PackedSimd.Or(PackedSimd.Swizzle(s0, f1A), PackedSimd.Swizzle(s1, f1B)).AsUInt16(), maskXYZ);
                var a_2 = PackedSimd.And(PackedSimd.Or(PackedSimd.Swizzle(s1, f2A), PackedSimd.Swizzle(s2, f2B)).AsUInt16(), maskXYZ);
                var a_3 = PackedSimd.And(PackedSimd.Swizzle(s2, f3).AsUInt16(), maskXYZ);
                result1 = a_1;
                result2 = a_2;
                result3 = a_3;
                return a_0;
            ...
            public static Vector128<uint> YGroup3ToGroup4_Shuffle(Vector128<uint> data0, Vector128<uint> data1, Vector128<uint> data2, out Vector128<uint> result1, out Vector128<uint> result2, out Vector128<uint> result3) {
                ...
                var s1 = data1.AsByte();
                var s2 = data2.AsByte();
                var a_0 = PackedSimd.And(data0, maskXYZ);
                var a_1 = PackedSimd.And(PackedSimd.Or(PackedSimd.Swizzle(s0, f1A), PackedSimd.Swizzle(s1, f1B)).AsUInt32(), maskXYZ);
                var a_2 = PackedSimd.And(PackedSimd.Or(PackedSimd.Swizzle(s1, f2A), PackedSimd.Swizzle(s2, f2B)).AsUInt32(), maskXYZ);
                var a_3 = PackedSimd.And(PackedSimd.Swizzle(s2, f3).AsUInt32(), maskXYZ);
                result1 = a_1;
                result2 = a_2;
                result3 = a_3;
                return a_0;
            ...
            public static Vector128<ulong> YGroup3ToGroup4_Shuffle(Vector128<ulong> data0, Vector128<ulong> data1, Vector128<ulong> data2, out Vector128<ulong> result1, out Vector128<ulong> result2, out Vector128<ulong> result3) {
                ...
                var s2 = data2.AsByte();
                var a_0 = data0;
                var a_1 = PackedSimd.And(data1, maskXYZ);
                var a_2 = PackedSimd.Or(PackedSimd.Swizzle(s1, f2A), PackedSimd.Swizzle(s2, f2B)).AsUInt64();
                var a_3 = PackedSimd.And(PackedSimd.Swizzle(s2, f3).AsUInt64(), maskXYZ);
                result1 = a_1;
                result2 = a_2;
                result3 = a_3;
                return a_0;
            ...
            public static Vector128<byte> YGroup3Unzip_Shuffle(Vector128<byte> data0, Vector128<byte> data1, Vector128<byte> data2, out Vector128<byte> y, out Vector128<byte> z) {
                ...
                var rt0 = PackedSimd.Or(PackedSimd.Or(PackedSimd.Swizzle(data0, f0A), PackedSimd.Swizzle(data1, f0B)), PackedSimd.Swizzle(data2, f0C));
                var rt1 = PackedSimd.Or(PackedSimd.Or(PackedSimd.Swizzle(data0, f1A), PackedSimd.Swizzle(data1, f1B)), PackedSimd.Swizzle(data2, f1C));
                var rt2 = PackedSimd.Or(PackedSimd.Or(PackedSimd.Swizzle(data0, f2A), PackedSimd.Swizzle(data1, f2B)), PackedSimd.Swizzle(data2, f2C));
                y = rt1;
                z = rt2;
                return rt0;
            }
            ...
            public static Vector128<ushort> YGroup3Unzip_Shuffle(Vector128<ushort> data0, Vector128<ushort> data1, Vector128<ushort> data2, out Vector128<ushort> y, out Vector128<ushort> z) {
                ...
                var s1 = data1.AsByte();
                var s2 = data2.AsByte();
                var rt0 = PackedSimd.Or(PackedSimd.Or(PackedSimd.Swizzle(s0, f0A), PackedSimd.Swizzle(s1, f0B)), PackedSimd.Swizzle(s2, f0C)).AsUInt16();
                var rt1 = PackedSimd.Or(PackedSimd.Or(PackedSimd.Swizzle(s0, f1A), PackedSimd.Swizzle(s1, f1B)), PackedSimd.Swizzle(s2, f1C)).AsUInt16();
                var rt2 = PackedSimd.Or(PackedSimd.Or(PackedSimd.Swizzle(s0, f2A), PackedSimd.Swizzle(s1, f2B)), PackedSimd.Swizzle(s2, f2C)).AsUInt16();
            ...
            public static Vector128<uint> YGroup3Unzip_Shuffle(Vector128<uint> data0, Vector128<uint> data1, Vector128<uint> data2, out Vector128<uint> y, out Vector128<uint> z) {
                ...
                var s1 = data1.AsByte();
                var s2 = data2.AsByte();
                var rt0 = PackedSimd.Or(PackedSimd.Or(PackedSimd.Swizzle(s0, f0A), PackedSimd.Swizzle(s1, f0B)), PackedSimd.Swizzle(s2, f0C)).AsUInt32();
                var rt1 = PackedSimd.Or(PackedSimd.Or(PackedSimd.Swizzle(s0, f1A), PackedSimd.Swizzle(s1, f1B)), PackedSimd.Swizzle(s2, f1C)).AsUInt32();
                var rt2 = PackedSimd.Or(PackedSimd.Or(PackedSimd.Swizzle(s0, f2A), PackedSimd.Swizzle(s1, f2B)), PackedSimd.Swizzle(s2, f2C)).AsUInt32();
                y = rt1;
                z = rt2;
                return rt0;
            }
            ...
            public static Vector128<ulong> YGroup3Unzip_Shuffle(Vector128<ulong> data0, Vector128<ulong> data1, Vector128<ulong> data2, out Vector128<ulong> y, out Vector128<ulong> z) {
                ...
                var s1 = data1.AsByte();
                var s2 = data2.AsByte();
                var rt0 = PackedSimd.Or(PackedSimd.Swizzle(s0, f0A), PackedSimd.Swizzle(s1, f0B)).AsUInt64();
                var rt1 = PackedSimd.Or(PackedSimd.Swizzle(s0, f1A), PackedSimd.Swizzle(s2, f1C)).AsUInt64();
                var rt2 = PackedSimd.Or(PackedSimd.Swizzle(s1, f2B), PackedSimd.Swizzle(s2, f2C)).AsUInt64();
                y = rt1;
                z = rt2;
                return rt0;
            }
            ...
            public static Vector128<byte> YGroup3Zip_Shuffle(Vector128<byte> x, Vector128<byte> y, Vector128<byte> z, out Vector128<byte> data1, out Vector128<byte> data2) {
                ...
                var rt0 = PackedSimd.Or(PackedSimd.Or(PackedSimd.Swizzle(x, f0A), PackedSimd.Swizzle(y, f0B)), PackedSimd.Swizzle(z, f0C));
                var rt1 = PackedSimd.Or(PackedSimd.Or(PackedSimd.Swizzle(x, f1A), PackedSimd.Swizzle(y, f1B)), PackedSimd.Swizzle(z, f1C));
                var rt2 = PackedSimd.Or(PackedSimd.Or(PackedSimd.Swizzle(x, f2A), PackedSimd.Swizzle(y, f2B)), PackedSimd.Swizzle(z, f2C));
                data1 = rt1;
                data2 = rt2;
                return rt0;
            }
            ...
            public static Vector128<byte> YGroup4ToGroup3_Shuffle(Vector128<byte> data0, Vector128<byte> data1, Vector128<byte> data2, Vector128<byte> data3, out Vector128<byte> result1, out Vector128<byte> result2) {
                ...
                var a_0 = PackedSimd.Or(PackedSimd.Swizzle(data0, f0A), PackedSimd.Swizzle(data1, f0B));
                var a_1 = PackedSimd.Or(PackedSimd.Swizzle(data1, f1A), PackedSimd.Swizzle(data2, f1B));
                var a_2 = PackedSimd.Or(PackedSimd.Swizzle(data2, f2A), PackedSimd.Swizzle(data3, f2B));
                result1 = a_1;
                result2 = a_2;
                return a_0;
            }
            ...
            public static Vector128<ushort> YGroup4ToGroup3_Shuffle(Vector128<ushort> data0, Vector128<ushort> data1, Vector128<ushort> data2, Vector128<ushort> data3, out Vector128<ushort> result1, out Vector128<ushort> result2) {
                ...
                var s2 = data2.AsByte();
                var s3 = data3.AsByte();
                var a_0 = PackedSimd.Or(PackedSimd.Swizzle(s0, f0A), PackedSimd.Swizzle(s1, f0B)).AsUInt16();
                var a_1 = PackedSimd.Or(PackedSimd.Swizzle(s1, f1A), PackedSimd.Swizzle(s2, f1B)).AsUInt16();
                var a_2 = PackedSimd.Or(PackedSimd.Swizzle(s2, f2A), PackedSimd.Swizzle(s3, f2B)).AsUInt16();
                result1 = a_1;
                result2 = a_2;
                return a_0;
            }
            ...
            public static Vector128<uint> YGroup4ToGroup3_Shuffle(Vector128<uint> data0, Vector128<uint> data1, Vector128<uint> data2, Vector128<uint> data3, out Vector128<uint> result1, out Vector128<uint> result2) {
                ...
                var s2 = data2.AsByte();
                var s3 = data3.AsByte();
                var a_0 = PackedSimd.Or(PackedSimd.Swizzle(s0, f0A), PackedSimd.Swizzle(s1, f0B)).AsUInt32();
                var a_1 = PackedSimd.Or(PackedSimd.Swizzle(s1, f1A), PackedSimd.Swizzle(s2, f1B)).AsUInt32();
                var a_2 = PackedSimd.Or(PackedSimd.Swizzle(s2, f2A), PackedSimd.Swizzle(s3, f2B)).AsUInt32();
                result1 = a_1;
                result2 = a_2;
                return a_0;
            }
            ...
            public static Vector128<ulong> YGroup4ToGroup3_Shuffle(Vector128<ulong> data0, Vector128<ulong> data1, Vector128<ulong> data2, Vector128<ulong> data3, out Vector128<ulong> result1, out Vector128<ulong> result2) {
                ...
                var s3 = data3.AsByte();
                var a_0 = data0;
                var a_1 = PackedSimd.Or(PackedSimd.Swizzle(s1, f1A), PackedSimd.Swizzle(s2, f1B)).AsUInt64();
                var a_2 = PackedSimd.Or(PackedSimd.Swizzle(s2, f2A), PackedSimd.Swizzle(s3, f2B)).AsUInt64();
                result1 = a_1;
                result2 = a_2;
                return a_0;
            }
