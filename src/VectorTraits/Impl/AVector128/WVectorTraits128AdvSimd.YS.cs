    ...
    partial class WVectorTraits128AdvSimd {
        ...
        partial class Statics {
            ...
            public static Vector128<byte> YShuffleX2Insert(Vector128<byte> back, Vector128<byte> vector0, Vector128<byte> vector1, Vector128<byte> indices) {
                ...
                var lower = AdvSimd.VectorTableLookupExtension(back.GetLower(), (vector0, vector1), indices.GetLower());
                var upper = AdvSimd.VectorTableLookupExtension(back.GetUpper(), (vector0, vector1), indices.GetUpper());
                var rt = lower.ToVector128Unsafe().WithUpper(upper);
                return rt;
#else
            ...
            public static Vector128<byte> YShuffleX2Insert_Core(Vector128<byte> back, Vector128<byte> vector0, Vector128<byte> vector1, Vector128<byte> args0, Vector128<byte> args1, Vector128<byte> args2, Vector128<byte> args3, Vector128<byte> args4) {
                ...
                _ = args3;
                _ = args4;
                var lower = AdvSimd.VectorTableLookupExtension(back.GetLower(), (vector0, vector1), args0.GetLower());
                var upper = AdvSimd.VectorTableLookupExtension(back.GetUpper(), (vector0, vector1), args0.GetUpper());
                var rt = lower.ToVector128Unsafe().WithUpper(upper);
#else
                Vector128<byte> rt = YShuffleX2Kernel_Core(vector0, vector1, args0, args1, args2, args3);
...
#if ARM_ALLOW_LOOKUP_X
                var lower = AdvSimd.VectorTableLookup((vector0, vector1), indices.GetLower());
                var upper = AdvSimd.VectorTableLookup((vector0, vector1), indices.GetUpper());
                var rt = lower.ToVector128Unsafe().WithUpper(upper);
                return rt;
#else
...
#if ARM_ALLOW_LOOKUP_X
                _ = args1;
                var lower = AdvSimd.VectorTableLookup((vector0, vector1), args0.GetLower());
                var upper = AdvSimd.VectorTableLookup((vector0, vector1), args0.GetUpper());
                var rt = lower.ToVector128Unsafe().WithUpper(upper);
                return rt;
#else
...
#if ARM_ALLOW_LOOKUP_X
                var lower = AdvSimd.VectorTableLookupExtension(back.GetLower(), (vector0, vector1, vector2), indices.GetLower());
                var upper = AdvSimd.VectorTableLookupExtension(back.GetUpper(), (vector0, vector1, vector2), indices.GetUpper());
                var rt = lower.ToVector128Unsafe().WithUpper(upper);
                return rt;
#else
            ...
            public static Vector128<byte> YShuffleX3Insert_Core(Vector128<byte> back, Vector128<byte> vector0, Vector128<byte> vector1, Vector128<byte> vector2, Vector128<byte> args0, Vector128<byte> args1, Vector128<byte> args2, Vector128<byte> args3, Vector128<byte> args4) {
                ...
                _ = args3;
                _ = args4;
                var lower = AdvSimd.VectorTableLookupExtension(back.GetLower(), (vector0, vector1, vector2), args0.GetLower());
                var upper = AdvSimd.VectorTableLookupExtension(back.GetUpper(), (vector0, vector1, vector2), args0.GetUpper());
                var rt = lower.ToVector128Unsafe().WithUpper(upper);
                return rt;
#else
                Vector128<byte> rt = YShuffleX3Kernel_Core(vector0, vector1, vector2, args0, args1, args2, args3);
...
#if ARM_ALLOW_LOOKUP_X
                var lower = AdvSimd.VectorTableLookup((vector0, vector1, vector2), indices.GetLower());
                var upper = AdvSimd.VectorTableLookup((vector0, vector1, vector2), indices.GetUpper());
                var rt = lower.ToVector128Unsafe().WithUpper(upper);
                return rt;
#else
            ...
            public static Vector128<byte> YShuffleX3Kernel_Core(Vector128<byte> vector0, Vector128<byte> vector1, Vector128<byte> vector2, Vector128<byte> args0, Vector128<byte> args1, Vector128<byte> args2, Vector128<byte> args3) {
                ...
                _ = args2;
                _ = args3;
                var lower = AdvSimd.VectorTableLookup((vector0, vector1, vector2), args0.GetLower());
                var upper = AdvSimd.VectorTableLookup((vector0, vector1, vector2), args0.GetUpper());
                var rt = lower.ToVector128Unsafe().WithUpper(upper);
                return rt;
#else
...
#if ARM_ALLOW_LOOKUP_X
                var lower = AdvSimd.VectorTableLookupExtension(back.GetLower(), (vector0, vector1, vector2, vector3), indices.GetLower());
                var upper = AdvSimd.VectorTableLookupExtension(back.GetUpper(), (vector0, vector1, vector2, vector3), indices.GetUpper());
                var rt = lower.ToVector128Unsafe().WithUpper(upper);
                return rt;
#else
            ...
            public static Vector128<byte> YShuffleX4Insert_Core(Vector128<byte> back, Vector128<byte> vector0, Vector128<byte> vector1, Vector128<byte> vector2, Vector128<byte> vector3, Vector128<byte> args0, Vector128<byte> args1, Vector128<byte> args2, Vector128<byte> args3, Vector128<byte> args4) {
                ...
                _ = args3;
                _ = args4;
                var lower = AdvSimd.VectorTableLookupExtension(back.GetLower(), (vector0, vector1, vector2, vector3), args0.GetLower());
                var upper = AdvSimd.VectorTableLookupExtension(back.GetUpper(), (vector0, vector1, vector2, vector3), args0.GetUpper());
                var rt = lower.ToVector128Unsafe().WithUpper(upper);
                return rt;
#else
                Vector128<byte> rt = YShuffleX4Kernel_Core(vector0, vector1, vector2, vector3, args0, args1, args2, args3);
...
#if ARM_ALLOW_LOOKUP_X
                var lower = AdvSimd.VectorTableLookup((vector0, vector1, vector2, vector3), indices.GetLower());
                var upper = AdvSimd.VectorTableLookup((vector0, vector1, vector2, vector3), indices.GetUpper());
                var rt = lower.ToVector128Unsafe().WithUpper(upper);
                return rt;
#else
            ...
            public static Vector128<byte> YShuffleX4Kernel_Core(Vector128<byte> vector0, Vector128<byte> vector1, Vector128<byte> vector2, Vector128<byte> vector3, Vector128<byte> args0, Vector128<byte> args1, Vector128<byte> args2, Vector128<byte> args3) {
                ...
                _ = args2;
                _ = args3;
                var lower = AdvSimd.VectorTableLookup((vector0, vector1, vector2, vector3), args0.GetLower());
                var upper = AdvSimd.VectorTableLookup((vector0, vector1, vector2, vector3), args0.GetUpper());
                var rt = lower.ToVector128Unsafe().WithUpper(upper);
                return rt;
#else
            ...
            public static Vector128<int> YSign(Vector128<float> value) {
                ...
                Vector128<int> rt = AdvSimd.Subtract(m, n);
                return rt;
            }
            ...
            public static Vector128<sbyte> YSign(Vector128<sbyte> value) {
                ...
                Vector128<sbyte> rt = AdvSimd.Subtract(m, n);
                return rt;
            }
            ...
            public static Vector128<short> YSign(Vector128<short> value) {
                ...
                Vector128<short> rt = AdvSimd.Subtract(m, n);
                return rt;
            }
