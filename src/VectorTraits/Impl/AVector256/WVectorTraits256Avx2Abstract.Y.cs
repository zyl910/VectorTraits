...
namespace Zyl.VectorTraits.Impl.AVector256 {
    ...
    partial class WVectorTraits256Avx2Abstract {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public override Vector256<T> YGroup2Unzip_Int128<T>(Vector256<T> data0, Vector256<T> data1, out Vector256<T> y) where T : struct {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public override Vector256<T> YGroup2Zip_Int128<T>(Vector256<T> x, Vector256<T> y, out Vector256<T> data1) where T : struct {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public override Vector256<T> YGroup3Unzip_Int128<T>(Vector256<T> data0, Vector256<T> data1, Vector256<T> data2, out Vector256<T> y, out Vector256<T> z) where T : struct {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public override Vector256<T> YGroup3UnzipX2_Int128<T>(Vector256<T> data0, Vector256<T> data1, Vector256<T> data2, Vector256<T> data3, Vector256<T> data4, Vector256<T> data5, out Vector256<T> xB, out Vector256<T> y, out Vector256<T> yB, out Vector256<T> z, out Vector256<T> zB) where T : struct {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public override Vector256<T> YGroup4Unzip_Int128<T>(Vector256<T> data0, Vector256<T> data1, Vector256<T> data2, Vector256<T> data3, out Vector256<T> y, out Vector256<T> z, out Vector256<T> w) where T : struct {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public override Vector256<T> YGroup4Zip_Int128<T>(Vector256<T> x, Vector256<T> y, Vector256<T> z, Vector256<T> w, out Vector256<T> data1, out Vector256<T> data2, out Vector256<T> data3) where T : struct {
