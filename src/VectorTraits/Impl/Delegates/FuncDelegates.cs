...
namespace Zyl.VectorTraits.Impl.Delegates {
    ...
    /// <summary>
    /// Functions with 1 input parameters and 3 output parameter (具有1个输入参数与3个输出参数的函数).
    /// </summary>
    /// <typeparam name="T">Type of parameter (参数的类型).</typeparam>
    /// <param name="in0">The 0th input parameter (第0个输入参数).</param>
    /// <param name="result1">The 1st output parameter (第1个输出参数).</param>
    /// <param name="result2">The 2nd output parameter (第2个输出参数).</param>
    /// <returns>The 0th output parameter (第0个输出参数).</returns>
    public delegate T FuncIn1Out2<T>(T in0, out T result1, out T result2);

    /// <summary>
    /// Functions with 1 input parameters and 4 output parameter (具有1个输入参数与4个输出参数的函数).
    /// </summary>
    /// <typeparam name="T">Type of parameter (参数的类型).</typeparam>
    /// <param name="in0">The 0th input parameter (第0个输入参数).</param>
    /// <param name="result1">The 1st output parameter (第1个输出参数).</param>
    /// <param name="result2">The 2nd output parameter (第2个输出参数).</param>
    /// <param name="result3">The 3rd output parameter (第3个输出参数).</param>
    /// <returns>The 0th output parameter (第0个输出参数).</returns>
    public delegate T FuncIn1Out3<T>(T in0, out T result1, out T result2, out T result3);
    ...
    /// <typeparam name="T">Type of parameter (参数的类型).</typeparam>
    /// <param name="in0">The 0th input parameter (第0个输入参数).</param>
    /// <param name="in1">The 1st input parameter (第1个输入参数).</param>
    /// <param name="result1">The 1st output parameter (第1个输出参数).</param>
    /// <returns>The 0th output parameter (第0个输出参数).</returns>
    public delegate T FuncIn2Out1<T>(T in0, T in1, out T result1);

    /// <summary>
    /// Functions with 2 input parameters and 3 output parameter (具有2个输入参数与3个输出参数的函数).
    /// </summary>
    /// <typeparam name="T">Type of parameter (参数的类型).</typeparam>
    /// <param name="in0">The 0th input parameter (第0个输入参数).</param>
    /// <param name="in1">The 1st input parameter (第1个输入参数).</param>
    ...
    /// <param name="result3">The 3rd output parameter (第3个输出参数).</param>
    /// <returns>The 0th output parameter (第0个输出参数).</returns>
    public delegate T FuncIn2Out3<T>(T in0, T in1, out T result1, out T result2, out T result3);
    ...
    /// <param name="in0">The 0th input parameter (第0个输入参数).</param>
    /// <param name="in1">The 1st input parameter (第1个输入参数).</param>
    /// <param name="in2">The 2nd input parameter (第2个输入参数).</param>
    /// <param name="result1">The 1st output parameter (第1个输出参数).</param>
    /// <param name="result2">The 2nd output parameter (第2个输出参数).</param>
    /// <returns>The 0th output parameter (第0个输出参数).</returns>
    ...
    /// <param name="in1">The 1st input parameter (第1个输入参数).</param>
    /// <param name="in2">The 2nd input parameter (第2个输入参数).</param>
    /// <param name="in3">The 3rd input parameter (第3个输入参数).</param>
    /// <param name="result1">The 1st output parameter (第1个输出参数).</param>
    /// <param name="result2">The 2nd output parameter (第2个输出参数).</param>
    /// <returns>The 0th output parameter (第0个输出参数).</returns>
    ...
    /// <param name="in2">The 2nd input parameter (第2个输入参数).</param>
    /// <param name="in3">The 3rd input parameter (第3个输入参数).</param>
    /// <param name="in4">The 4th input parameter (第4个输入参数).</param>
    /// <param name="in5">The 5th input parameter (第5个输入参数).</param>
    /// <param name="result1">The 1st output parameter (第1个输出参数).</param>
    /// <param name="result2">The 2nd output parameter (第2个输出参数).</param>
    /// <param name="result3">The 3rd output parameter (第3个输出参数).</param>
    /// <param name="result4">The 4th output parameter (第4个输出参数).</param>
    /// <param name="result5">The 5th output parameter (第5个输出参数).</param>
    /// <returns>The 0th output parameter (第0个输出参数).</returns>
