...
namespace Zyl.VectorTraits.Impl {
    ...
    public partial interface IWVectorTraits128 : IWVectorTraits {
        ...
        /// </remarks>
        /// <seealso cref="Ceiling(Vector128{float})"/>
        ...
        /// </remarks>
        /// <seealso cref="ConvertToDouble(Vector128{long})"/>
        /// <seealso cref="ConvertToDouble_Range52(Vector128{long})"/>
        ...
        /// <returns>The converted vector (转换后的向量).</returns>
        /// <seealso cref="ConvertToInt64_AcceleratedTypes"/>
        Vector128<long> ConvertToInt64_Range52RoundToEven(Vector128<double> value);


        /// <summary>
        /// Types with hardware acceleration when running <c>ConvertToSingle</c> (运行 <c>ConvertToSingle</c> 时具有硬件加速的类型).
        /// </summary>
        /// <seealso cref="ConvertToSingle(Vector128{int})"/>
        ...
        /// <seealso cref="ConvertToUInt64_AcceleratedTypes"/>
        /// <seealso cref="Vector128.ConvertToUInt64(Vector128{double})" />
        Vector128<ulong> ConvertToUInt64_Range52(Vector128<double> value);
        ...
        /// <returns>The converted vector (转换后的向量).</returns>
        /// <seealso cref="ConvertToUInt64_AcceleratedTypes"/>
        Vector128<ulong> ConvertToUInt64_Range52RoundToEven(Vector128<double> value);
        ...
        /// </remarks>
        /// <seealso cref="ExtractMostSignificantBits(Vector128{byte})"/>
        ...
        /// <para>- <see cref="YRoundToZero(Vector128{float})"/>: Computes the round to zero of each element in a vector (计算向量中每个元素的向零舍入). It is also known as truncate (它也被称作截断取整). See more: <see cref="MidpointRounding.ToZero"/>.</para>
        /// </remarks>
        /// <seealso cref="Floor(Vector128{float})"/>
        ...
        /// </summary>
        /// <seealso cref="Narrow(Vector128{short}, Vector128{short})"/>
        ...
        /// <seealso cref="ShiftLeft_Const(Vector128{byte}, int)"/>
        /// <seealso cref="ShiftLeft_ConstCore(Vector128{byte}, int, Vector128{byte}, Vector128{byte})"/>
        ...
        /// <seealso cref="ShiftRightArithmetic_Const(Vector128{sbyte}, int)"/>
        /// <seealso cref="ShiftRightArithmetic_ConstCore(Vector128{sbyte}, int, Vector128{sbyte}, Vector128{sbyte})"/>
        ...
        /// <seealso cref="ShiftRightLogical_Const(Vector128{byte}, int)"/>
        /// <seealso cref="ShiftRightLogical_ConstCore(Vector128{byte}, int, Vector128{byte}, Vector128{byte})"/>
        ...
        /// </list>
        /// </remarks>
        /// <seealso cref="Shuffle(Vector128{byte}, Vector128{byte})"/>
        ...
        /// </summary>
        /// <seealso cref="Sum(Vector128{byte})"/>
        ...
        /// </summary>
        /// <seealso cref="Widen(Vector128{byte}, out Vector128{ushort}, out Vector128{ushort})"/>
        ...
        /// </summary>
        /// <seealso cref="WidenLower(Vector128{float})" />
        ...
        /// <seealso cref="Vector128.WidenLower(Vector128{float})" />
        Vector128<double> WidenLower(Vector128<float> source);

        /// <inheritdoc cref="WidenLower(Vector128{float})"/>
        /// <seealso cref="Vector128.WidenLower(Vector128{sbyte})" />
        Vector128<short> WidenLower(Vector128<sbyte> source);

        /// <inheritdoc cref="WidenLower(Vector128{float})"/>
        /// <seealso cref="Vector128.WidenLower(Vector128{byte})" />
        Vector128<ushort> WidenLower(Vector128<byte> source);

        /// <inheritdoc cref="WidenLower(Vector128{float})"/>
        /// <seealso cref="Vector128.WidenLower(Vector128{short})" />
        Vector128<int> WidenLower(Vector128<short> source);

        /// <inheritdoc cref="WidenLower(Vector128{float})"/>
        /// <seealso cref="Vector128.WidenLower(Vector128{ushort})" />
        Vector128<uint> WidenLower(Vector128<ushort> source);

        /// <inheritdoc cref="WidenLower(Vector128{float})"/>
        /// <seealso cref="Vector128.WidenLower(Vector128{int})" />
        Vector128<long> WidenLower(Vector128<int> source);

        /// <inheritdoc cref="WidenLower(Vector128{float})"/>
        /// <seealso cref="Vector128.WidenLower(Vector128{uint})" />
        ...
        /// </summary>
        /// <seealso cref="WidenUpper(Vector128{float})" />
        ...
        /// <seealso cref="Vector128.WidenUpper(Vector128{float})" />
        Vector128<double> WidenUpper(Vector128<float> source);

        /// <inheritdoc cref="WidenUpper(Vector128{float})"/>
        /// <seealso cref="Vector128.WidenUpper(Vector128{sbyte})" />
        Vector128<short> WidenUpper(Vector128<sbyte> source);

        /// <inheritdoc cref="WidenUpper(Vector128{float})"/>
        /// <seealso cref="Vector128.WidenUpper(Vector128{byte})" />
        Vector128<ushort> WidenUpper(Vector128<byte> source);

        /// <inheritdoc cref="WidenUpper(Vector128{float})"/>
        /// <seealso cref="Vector128.WidenUpper(Vector128{short})" />
        Vector128<int> WidenUpper(Vector128<short> source);

        /// <inheritdoc cref="WidenUpper(Vector128{float})"/>
        /// <seealso cref="Vector128.WidenUpper(Vector128{ushort})" />
        Vector128<uint> WidenUpper(Vector128<ushort> source);

        /// <inheritdoc cref="WidenUpper(Vector128{float})"/>
        /// <seealso cref="Vector128.WidenUpper(Vector128{int})" />
        Vector128<long> WidenUpper(Vector128<int> source);

        /// <inheritdoc cref="WidenUpper(Vector128{float})"/>
        /// <seealso cref="Vector128.WidenUpper(Vector128{uint})" />
