    ...
    partial class VectorTraitsBase {
        ...
        partial class Statics {
            ...
            public static Vector<float> YGroup2Transpose(Vector<float> data0, Vector<float> data1, out Vector<float> result1) {
                var d0 = YGroup2Transpose(data0.AsUInt32(), data1.AsUInt32(), out var d1);
                result1 = d1.AsSingle();
                return d0.AsSingle();
            }
            ...
            public static Vector<double> YGroup2Transpose(Vector<double> data0, Vector<double> data1, out Vector<double> result1) {
                var d0 = YGroup2Transpose(data0.AsUInt64(), data1.AsUInt64(), out var d1);
                result1 = d1.AsDouble();
                return d0.AsDouble();
            }
...
#else
                    return YGroup2Transpose_ShiftByMul(data0, data1, out result1);
#endif // BCL_HAS_SHIFT
                }
#endif // BCL_OVERRIDE_BASE_VAR && VECTOR_HAS_METHOD
            ...
            /// <inheritdoc cref="IVectorTraits.YGroup2Transpose(Vector{float}, Vector{float}, out Vector{float})"/>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Vector<float> YGroup2Transpose_Basic(Vector<float> data0, Vector<float> data1, out Vector<float> result1) {
            ...
            /// <inheritdoc cref="IVectorTraits.YGroup2Transpose(Vector{double}, Vector{double}, out Vector{double})"/>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Vector<double> YGroup2Transpose_Basic(Vector<double> data0, Vector<double> data1, out Vector<double> result1) {
            ...
            [CLSCompliant(false)]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Vector<sbyte> YGroup2Transpose_Basic(Vector<sbyte> data0, Vector<sbyte> data1, out Vector<sbyte> result1) {
            ...
            /// <inheritdoc cref="IVectorTraits.YGroup2Transpose(Vector{byte}, Vector{byte}, out Vector{byte})"/>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Vector<byte> YGroup2Transpose_Basic(Vector<byte> data0, Vector<byte> data1, out Vector<byte> result1) {
                Unsafe.SkipInit(out Vector<byte> rt0);
                Unsafe.SkipInit(out Vector<byte> rt1);
            ...
            /// <inheritdoc cref="IVectorTraits.YGroup2Transpose(Vector{short}, Vector{short}, out Vector{short})"/>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Vector<short> YGroup2Transpose_Basic(Vector<short> data0, Vector<short> data1, out Vector<short> result1) {
            ...
            [CLSCompliant(false)]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Vector<ushort> YGroup2Transpose_Basic(Vector<ushort> data0, Vector<ushort> data1, out Vector<ushort> result1) {
                Unsafe.SkipInit(out Vector<ushort> rt0);
                Unsafe.SkipInit(out Vector<ushort> rt1);
            ...
            /// <inheritdoc cref="IVectorTraits.YGroup2Transpose(Vector{int}, Vector{int}, out Vector{int})"/>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Vector<int> YGroup2Transpose_Basic(Vector<int> data0, Vector<int> data1, out Vector<int> result1) {
                var d0 = YGroup2Transpose_Basic(data0.AsUInt32(), data1.AsUInt32(), out var d1);
                result1 = d1.AsInt32();
                return d0.AsInt32();
            }
            ...
            [CLSCompliant(false)]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Vector<uint> YGroup2Transpose_Basic(Vector<uint> data0, Vector<uint> data1, out Vector<uint> result1) {
                Unsafe.SkipInit(out Vector<uint> rt0);
                Unsafe.SkipInit(out Vector<uint> rt1);
            ...
            /// <inheritdoc cref="IVectorTraits.YGroup2Transpose(Vector{long}, Vector{long}, out Vector{long})"/>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Vector<long> YGroup2Transpose_Basic(Vector<long> data0, Vector<long> data1, out Vector<long> result1) {
                var d0 = YGroup2Transpose_Basic(data0.AsUInt64(), data1.AsUInt64(), out var d1);
                result1 = d1.AsInt64();
                return d0.AsInt64();
            }
            ...
            [CLSCompliant(false)]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Vector<ulong> YGroup2Transpose_Basic(Vector<ulong> data0, Vector<ulong> data1, out Vector<ulong> result1) {
                Unsafe.SkipInit(out Vector<ulong> rt0);
                Unsafe.SkipInit(out Vector<ulong> rt1);
            ...
            /// <inheritdoc cref="IVectorTraits.YGroup2Transpose(Vector{float}, Vector{float}, out Vector{float})"/>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Vector<float> YGroup2Transpose_Shift(Vector<float> data0, Vector<float> data1, out Vector<float> result1) {
            ...
            [CLSCompliant(false)]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Vector<sbyte> YGroup2Transpose_Shift(Vector<sbyte> data0, Vector<sbyte> data1, out Vector<sbyte> result1) {
            ...
            /// <inheritdoc cref="IVectorTraits.YGroup2Transpose(Vector{byte}, Vector{byte}, out Vector{byte})"/>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Vector<byte> YGroup2Transpose_Shift(Vector<byte> data0, Vector<byte> data1, out Vector<byte> result1) {
                const int L = 8;
                Vector<ushort> a_0, a_1, b_0, b_1, c_0, c_1;
                Vector<ushort> mask = new Vector<ushort>((ushort)0x00FFU);
                a_0 = data0.AsUInt16();
                a_1 = data1.AsUInt16();
                if (BitConverter.IsLittleEndian) {
                    ...
                    b_1 = Vector.ShiftRightLogical(a_1, L);
                    b_0 = Vector.ShiftLeft(a_0, L);
                    c_0 = Vector.BitwiseOr(Vector.AndNot(a_0, mask), b_1);
                    c_1 = Vector.BitwiseOr(Vector.BitwiseAnd(a_1, mask), b_0);
                }
                result1 = c_1.AsByte();
                return c_0.AsByte();
            }
            ...
            /// <inheritdoc cref="IVectorTraits.YGroup2Transpose(Vector{short}, Vector{short}, out Vector{short})"/>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Vector<short> YGroup2Transpose_Shift(Vector<short> data0, Vector<short> data1, out Vector<short> result1) {
            ...
            [CLSCompliant(false)]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Vector<ushort> YGroup2Transpose_Shift(Vector<ushort> data0, Vector<ushort> data1, out Vector<ushort> result1) {
                const int L = 16;
                Vector<uint> a_0, a_1, b_0, b_1, c_0, c_1;
                Vector<uint> mask = new Vector<uint>(0x0000FFFFU);
                a_0 = data0.AsUInt32();
                a_1 = data1.AsUInt32();
                if (BitConverter.IsLittleEndian) {
                    b_1 = Vector.ShiftLeft(a_1, L);
            ...
            /// <inheritdoc cref="IVectorTraits.YGroup2Transpose(Vector{int}, Vector{int}, out Vector{int})"/>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Vector<int> YGroup2Transpose_Shift(Vector<int> data0, Vector<int> data1, out Vector<int> result1) {
                var d0 = YGroup2Transpose_Shift(data0.AsUInt32(), data1.AsUInt32(), out var d1);
                result1 = d1.AsInt32();
                return d0.AsInt32();
            }
            ...
            [CLSCompliant(false)]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Vector<uint> YGroup2Transpose_Shift(Vector<uint> data0, Vector<uint> data1, out Vector<uint> result1) {
                const int L = 32;
            ...
            [CLSCompliant(false)]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Vector<sbyte> YGroup2Transpose_ShiftByMul(Vector<sbyte> data0, Vector<sbyte> data1, out Vector<sbyte> result1) {
                var d0 = YGroup2Transpose_ShiftByMul(data0.AsByte(), data1.AsByte(), out var d1);
                result1 = d1.AsSByte();
                return d0.AsSByte();
            }
            ...
            /// <inheritdoc cref="IVectorTraits.YGroup2Transpose(Vector{byte}, Vector{byte}, out Vector{byte})"/>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Vector<byte> YGroup2Transpose_ShiftByMul(Vector<byte> data0, Vector<byte> data1, out Vector<byte> result1) {
                const int L = 8;
                const short scaleMul = 1 << L;
                const float scaleDiv = 1.0f / scaleMul;
                Vector<short> vscaleMul = new Vector<short>(scaleMul);
                Vector<float> vscaleDiv = new Vector<float>(scaleDiv);
                Vector<uint> e_0, e_1;
                ...
                f_1 = Vector.Multiply(f_1, vscaleDiv);
                e_0 = Vector.ConvertToInt32(f_0).AsUInt32();
                e_1 = Vector.ConvertToInt32(f_1).AsUInt32();
                b_0 = Vector.Narrow(e_0, e_1);
                // BitwiseOr.
                c_0 = Vector.BitwiseOr(Vector.BitwiseAnd(a_0, mask), b_1);
                c_1 = Vector.BitwiseOr(Vector.AndNot(a_1, mask), b_0);
                if (BitConverter.IsLittleEndian) {
            ...
            /// <inheritdoc cref="IVectorTraits.YGroup2Transpose(Vector{short}, Vector{short}, out Vector{short})"/>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Vector<short> YGroup2Transpose_ShiftByMul(Vector<short> data0, Vector<short> data1, out Vector<short> result1) {
                var d0 = YGroup2Transpose_ShiftByMul(data0.AsUInt16(), data1.AsUInt16(), out var d1);
                result1 = d1.AsInt16();
                return d0.AsInt16();
            }
            ...
            [CLSCompliant(false)]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Vector<ushort> YGroup2Transpose_ShiftByMul(Vector<ushort> data0, Vector<ushort> data1, out Vector<ushort> result1) {
                const int L = 16;
                const int scaleMul = 1 << L;
                const float scaleDiv = 1.0f / scaleMul;
                Vector<int> vscaleMul = new Vector<int>(scaleMul);
                Vector<float> vscaleDiv = new Vector<float>(scaleDiv);
                Vector<float> f_0;
                Vector<uint> a_0, a_1, b_0, b_1, c_0, c_1;
                Vector<uint> mask = new Vector<uint>(0x0000FFFFU);
            ...
            public static Vector<byte> YGroup2Unzip_Basic(Vector<byte> data0, Vector<byte> data1, out Vector<byte> y) {
                Unsafe.SkipInit(out Vector<byte> x1);
                Unsafe.SkipInit(out Vector<byte> y1);
            ...
            public static Vector<ushort> YGroup2Unzip_Basic(Vector<ushort> data0, Vector<ushort> data1, out Vector<ushort> y) {
                Unsafe.SkipInit(out Vector<ushort> x1);
                Unsafe.SkipInit(out Vector<ushort> y1);
            ...
            public static Vector<uint> YGroup2Unzip_Basic(Vector<uint> data0, Vector<uint> data1, out Vector<uint> y) {
                Unsafe.SkipInit(out Vector<uint> x1);
                Unsafe.SkipInit(out Vector<uint> y1);
            ...
            public static Vector<ulong> YGroup2Unzip_Basic(Vector<ulong> data0, Vector<ulong> data1, out Vector<ulong> y) {
                Unsafe.SkipInit(out Vector<ulong> x1);
                Unsafe.SkipInit(out Vector<ulong> y1);
            ...
            public static Vector<ExUInt128> YGroup2Unzip_Basic(Vector<ExUInt128> data0, Vector<ExUInt128> data1, out Vector<ExUInt128> y) {
                Unsafe.SkipInit(out Vector<ExUInt128> x1);
                Unsafe.SkipInit(out Vector<ExUInt128> y1);
            ...
            public static Vector<byte> YGroup3Unzip_Basic(Vector<byte> data0, Vector<byte> data1, Vector<byte> data2, out Vector<byte> y, out Vector<byte> z) {
                Unsafe.SkipInit(out Vector<byte> x1);
                Unsafe.SkipInit(out Vector<byte> y1);
                Unsafe.SkipInit(out Vector<byte> z1);
                Span<Vector<byte>> src = [data0, data1, data2];
                ref byte px = ref Unsafe.As<Vector<byte>, byte>(ref x1);
                ref byte py = ref Unsafe.As<Vector<byte>, byte>(ref y1);
            ...
            public static Vector<ushort> YGroup3Unzip_Basic(Vector<ushort> data0, Vector<ushort> data1, Vector<ushort> data2, out Vector<ushort> y, out Vector<ushort> z) {
                Unsafe.SkipInit(out Vector<ushort> x1);
                Unsafe.SkipInit(out Vector<ushort> y1);
                Unsafe.SkipInit(out Vector<ushort> z1);
                Span<Vector<ushort>> src = [data0, data1, data2];
                ref ushort px = ref Unsafe.As<Vector<ushort>, ushort>(ref x1);
                ref ushort py = ref Unsafe.As<Vector<ushort>, ushort>(ref y1);
            ...
            public static Vector<uint> YGroup3Unzip_Basic(Vector<uint> data0, Vector<uint> data1, Vector<uint> data2, out Vector<uint> y, out Vector<uint> z) {
                Unsafe.SkipInit(out Vector<uint> x1);
                Unsafe.SkipInit(out Vector<uint> y1);
                Unsafe.SkipInit(out Vector<uint> z1);
                Span<Vector<uint>> src = [data0, data1, data2];
                ref uint px = ref Unsafe.As<Vector<uint>, uint>(ref x1);
                ref uint py = ref Unsafe.As<Vector<uint>, uint>(ref y1);
            ...
            public static Vector<ulong> YGroup3Unzip_Basic(Vector<ulong> data0, Vector<ulong> data1, Vector<ulong> data2, out Vector<ulong> y, out Vector<ulong> z) {
                Unsafe.SkipInit(out Vector<ulong> x1);
                Unsafe.SkipInit(out Vector<ulong> y1);
                Unsafe.SkipInit(out Vector<ulong> z1);
                Span<Vector<ulong>> src = [data0, data1, data2];
                ref ulong px = ref Unsafe.As<Vector<ulong>, ulong>(ref x1);
                ref ulong py = ref Unsafe.As<Vector<ulong>, ulong>(ref y1);
            ...
            public static Vector<ExUInt128> YGroup3Unzip_Basic(Vector<ExUInt128> data0, Vector<ExUInt128> data1, Vector<ExUInt128> data2, out Vector<ExUInt128> y, out Vector<ExUInt128> z) {
                Unsafe.SkipInit(out Vector<ExUInt128> x1);
                Unsafe.SkipInit(out Vector<ExUInt128> y1);
                Unsafe.SkipInit(out Vector<ExUInt128> z1);
            ...
            [CLSCompliant(false)]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Vector<sbyte> YGroup4ToGroup3_Basic(Vector<sbyte> data0, Vector<sbyte> data1, Vector<sbyte> data2, Vector<sbyte> data3, out Vector<sbyte> result1, out Vector<sbyte> result2) {
            ...
            /// <inheritdoc cref="IVectorTraits.YGroup4ToGroup3(Vector{byte}, Vector{byte}, Vector{byte}, Vector{byte}, out Vector{byte}, out Vector{byte})"/>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Vector<byte> YGroup4ToGroup3_Basic(Vector<byte> data0, Vector<byte> data1, Vector<byte> data2, Vector<byte> data3, out Vector<byte> result1, out Vector<byte> result2) {
            ...
            /// <inheritdoc cref="IVectorTraits.YGroup4ToGroup3(Vector{short}, Vector{short}, Vector{short}, Vector{short}, out Vector{short}, out Vector{short})"/>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Vector<short> YGroup4ToGroup3_Basic(Vector<short> data0, Vector<short> data1, Vector<short> data2, Vector<short> data3, out Vector<short> result1, out Vector<short> result2) {
            ...
            [CLSCompliant(false)]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Vector<ushort> YGroup4ToGroup3_Basic(Vector<ushort> data0, Vector<ushort> data1, Vector<ushort> data2, Vector<ushort> data3, out Vector<ushort> result1, out Vector<ushort> result2) {
            ...
            /// <inheritdoc cref="IVectorTraits.YGroup4ToGroup3(Vector{int}, Vector{int}, Vector{int}, Vector{int}, out Vector{int}, out Vector{int})"/>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Vector<int> YGroup4ToGroup3_Basic(Vector<int> data0, Vector<int> data1, Vector<int> data2, Vector<int> data3, out Vector<int> result1, out Vector<int> result2) {
            ...
            [CLSCompliant(false)]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Vector<uint> YGroup4ToGroup3_Basic(Vector<uint> data0, Vector<uint> data1, Vector<uint> data2, Vector<uint> data3, out Vector<uint> result1, out Vector<uint> result2) {
            ...
            /// <inheritdoc cref="IVectorTraits.YGroup4ToGroup3(Vector{long}, Vector{long}, Vector{long}, Vector{long}, out Vector{long}, out Vector{long})"/>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Vector<long> YGroup4ToGroup3_Basic(Vector<long> data0, Vector<long> data1, Vector<long> data2, Vector<long> data3, out Vector<long> result1, out Vector<long> result2) {
            ...
            [CLSCompliant(false)]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Vector<ulong> YGroup4ToGroup3_Basic(Vector<ulong> data0, Vector<ulong> data1, Vector<ulong> data2, Vector<ulong> data3, out Vector<ulong> result1, out Vector<ulong> result2) {
            ...
            [CLSCompliant(false)]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Vector<sbyte> YGroup4ToGroup3_Unzip(Vector<sbyte> data0, Vector<sbyte> data1, Vector<sbyte> data2, Vector<sbyte> data3, out Vector<sbyte> result1, out Vector<sbyte> result2) {
            ...
            /// <inheritdoc cref="IVectorTraits.YGroup4ToGroup3(Vector{byte}, Vector{byte}, Vector{byte}, Vector{byte}, out Vector{byte}, out Vector{byte})"/>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Vector<byte> YGroup4ToGroup3_Unzip(Vector<byte> data0, Vector<byte> data1, Vector<byte> data2, Vector<byte> data3, out Vector<byte> result1, out Vector<byte> result2) {
            ...
            /// <inheritdoc cref="IVectorTraits.YGroup4ToGroup3(Vector{short}, Vector{short}, Vector{short}, Vector{short}, out Vector{short}, out Vector{short})"/>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Vector<short> YGroup4ToGroup3_Unzip(Vector<short> data0, Vector<short> data1, Vector<short> data2, Vector<short> data3, out Vector<short> result1, out Vector<short> result2) {
            ...
            [CLSCompliant(false)]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Vector<ushort> YGroup4ToGroup3_Unzip(Vector<ushort> data0, Vector<ushort> data1, Vector<ushort> data2, Vector<ushort> data3, out Vector<ushort> result1, out Vector<ushort> result2) {
                var a_0 = YGroup4Unzip(data0, data1, data2, data3, out var a_1, out var a_2, out _);
                var b_0 = YGroup3Zip(a_0, a_1, a_2, out var b_1, out var b_2);
                result1 = b_1;
                result2 = b_2;
            ...
            /// <inheritdoc cref="IVectorTraits.YGroup4ToGroup3(Vector{int}, Vector{int}, Vector{int}, Vector{int}, out Vector{int}, out Vector{int})"/>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Vector<int> YGroup4ToGroup3_Unzip(Vector<int> data0, Vector<int> data1, Vector<int> data2, Vector<int> data3, out Vector<int> result1, out Vector<int> result2) {
            ...
            [CLSCompliant(false)]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Vector<uint> YGroup4ToGroup3_Unzip(Vector<uint> data0, Vector<uint> data1, Vector<uint> data2, Vector<uint> data3, out Vector<uint> result1, out Vector<uint> result2) {
                var a_0 = YGroup4Unzip(data0, data1, data2, data3, out var a_1, out var a_2, out _);
                var b_0 = YGroup3Zip(a_0, a_1, a_2, out var b_1, out var b_2);
                result1 = b_1;
                result2 = b_2;
            ...
            public static Vector<byte> YGroup4Unzip_Basic(Vector<byte> data0, Vector<byte> data1, Vector<byte> data2, Vector<byte> data3, out Vector<byte> y, out Vector<byte> z, out Vector<byte> w) {
                ...
                Unsafe.SkipInit(out Vector<byte> y1);
                Unsafe.SkipInit(out Vector<byte> z1);
                Unsafe.SkipInit(out Vector<byte> w1);
                Span<Vector<byte>> src = [data0, data1, data2, data3];
                ref byte px = ref Unsafe.As<Vector<byte>, byte>(ref x1);
                ref byte py = ref Unsafe.As<Vector<byte>, byte>(ref y1);
                ref byte pz = ref Unsafe.As<Vector<byte>, byte>(ref z1);
            ...
            public static Vector<ushort> YGroup4Unzip_Basic(Vector<ushort> data0, Vector<ushort> data1, Vector<ushort> data2, Vector<ushort> data3, out Vector<ushort> y, out Vector<ushort> z, out Vector<ushort> w) {
                ...
                Unsafe.SkipInit(out Vector<ushort> y1);
                Unsafe.SkipInit(out Vector<ushort> z1);
                Unsafe.SkipInit(out Vector<ushort> w1);
                Span<Vector<ushort>> src = [data0, data1, data2, data3];
                ref ushort px = ref Unsafe.As<Vector<ushort>, ushort>(ref x1);
                ref ushort py = ref Unsafe.As<Vector<ushort>, ushort>(ref y1);
                ref ushort pz = ref Unsafe.As<Vector<ushort>, ushort>(ref z1);
            ...
            public static Vector<uint> YGroup4Unzip_Basic(Vector<uint> data0, Vector<uint> data1, Vector<uint> data2, Vector<uint> data3, out Vector<uint> y, out Vector<uint> z, out Vector<uint> w) {
                ...
                Unsafe.SkipInit(out Vector<uint> y1);
                Unsafe.SkipInit(out Vector<uint> z1);
                Unsafe.SkipInit(out Vector<uint> w1);
                Span<Vector<uint>> src = [data0, data1, data2, data3];
                ref uint px = ref Unsafe.As<Vector<uint>, uint>(ref x1);
                ref uint py = ref Unsafe.As<Vector<uint>, uint>(ref y1);
                ref uint pz = ref Unsafe.As<Vector<uint>, uint>(ref z1);
            ...
            public static Vector<ulong> YGroup4Unzip_Basic(Vector<ulong> data0, Vector<ulong> data1, Vector<ulong> data2, Vector<ulong> data3, out Vector<ulong> y, out Vector<ulong> z, out Vector<ulong> w) {
                ...
                Unsafe.SkipInit(out Vector<ulong> y1);
                Unsafe.SkipInit(out Vector<ulong> z1);
                Unsafe.SkipInit(out Vector<ulong> w1);
                Span<Vector<ulong>> src = [data0, data1, data2, data3];
                ref ulong px = ref Unsafe.As<Vector<ulong>, ulong>(ref x1);
                ref ulong py = ref Unsafe.As<Vector<ulong>, ulong>(ref y1);
                ref ulong pz = ref Unsafe.As<Vector<ulong>, ulong>(ref z1);
            ...
            public static Vector<ExUInt128> YGroup4Unzip_Basic(Vector<ExUInt128> data0, Vector<ExUInt128> data1, Vector<ExUInt128> data2, Vector<ExUInt128> data3, out Vector<ExUInt128> y, out Vector<ExUInt128> z, out Vector<ExUInt128> w) {
                ...
                Unsafe.SkipInit(out Vector<ExUInt128> y1);
                Unsafe.SkipInit(out Vector<ExUInt128> z1);
                Unsafe.SkipInit(out Vector<ExUInt128> w1);
