...
namespace Zyl.VectorTraits.Impl.AVector {
    ...
    partial class VectorTraitsAbstract {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual Vector<T> YGroup2Unzip_Int128<T>(Vector<T> data0, Vector<T> data1, out Vector<T> y) where T : struct {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual Vector<T> YGroup2Zip_Int128<T>(Vector<T> x, Vector<T> y, out Vector<T> data1) where T : struct {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual Vector<T> YGroup4Unzip_Int128<T>(Vector<T> data0, Vector<T> data1, Vector<T> data2, Vector<T> data3, out Vector<T> y, out Vector<T> z, out Vector<T> w) where T : struct {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public virtual Vector<T> YGroup4Zip_Int128<T>(Vector<T> x, Vector<T> y, Vector<T> z, Vector<T> w, out Vector<T> data1, out Vector<T> data2, out Vector<T> data3) where T : struct {
