...
namespace Zyl.VectorTraits.Impl.AVector {
    ...
    /// </summary>
    public sealed partial class VectorTraits128AdvSimd : VectorTraits128AdvSimdAbstract {
        ...
        public static partial class Statics {
            ...
            public static Vector<ulong> ShiftRightLogical_Fast_HwVar(Vector<ulong> value, int shiftAmount) {
                return WStatics.ShiftRightLogical_Fast_HwVar(value.AsVector128(), shiftAmount).AsVector();
            }

            /// <inheritdoc cref="IVectorTraits.ShiftRightLogical_Fast(Vector{ulong}, int)"/>
            [CLSCompliant(false)]
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static Vector<ulong> ShiftRightLogical_Fast_HwImm(Vector<ulong> value, int shiftAmount) {
                return WStatics.ShiftRightLogical_Fast_HwImm(value.AsVector128(), shiftAmount).AsVector();
            }
