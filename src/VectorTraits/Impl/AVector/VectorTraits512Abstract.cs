...
namespace Zyl.VectorTraits.Impl.AVector {
    using Statics = VectorTraits512Base.Statics;

    /// <summary>
    /// <see cref="Vector{T}"/> traits 512 - abstract.
    /// </summary>
    public abstract class VectorTraits512Abstract : VectorTraitsAbstract {
        ...
        public new static IVectorTraits GetBestInstance() {
            if (VectorTraits512Avx512.Instance.IsSupported) return VectorTraits512Avx512.Instance;
