    ...
    partial class VectorTraits512Avx512 {
        ...
        partial class Statics {
            ...
            public static float Dot(Vector<float> left, Vector<float> right) {
                return WStatics.Dot(left.AsVector512(), right.AsVector512());
            }
            ...
            public static Vector<sbyte> Multiply(Vector<sbyte> left, Vector<sbyte> right) {
                return WStatics.Multiply(left.AsVector512(), right.AsVector512()).AsVector();
            }
            ...
            public static Vector<float> Sqrt(Vector<float> value) {
                return WStatics.Sqrt(value.AsVector512()).AsVector();
            }
