    ...
    partial class VectorTraits256Avx2 {
        ...
        partial class Statics {
            ...
            public static Vector<float> YClamp(Vector<float> value, Vector<float> amin, Vector<float> amax) {
                return WStatics.YClamp(value.AsVector256(), amin.AsVector256(), amax.AsVector256()).AsVector();
            }
            ...
            public static Vector<float> YCopySign(Vector<float> value, Vector<float> sign) {
                return WStatics.YCopySign(value.AsVector256(), sign.AsVector256()).AsVector();
            }
            ...
            public static Vector<float> YMaxNumber(Vector<float> left, Vector<float> right) {
                return WStatics.YMaxNumber(left.AsVector256(), right.AsVector256()).AsVector();
            }
            ...
            public static Vector<float> YMinNumber(Vector<float> left, Vector<float> right) {
                return WStatics.YMinNumber(left.AsVector256(), right.AsVector256()).AsVector();
            }
            ...
            public static Vector<T> YOrNot<T>(Vector<T> left, Vector<T> right) where T : struct {
                return WStatics.YOrNot(left.AsVector256(), right.AsVector256()).AsVector();
            }
            ...
            public static Vector<float> YRoundToEven(Vector<float> value) {
                return WStatics.YRoundToEven(value.AsVector256()).AsVector();
            }
            ...
            public static Vector<float> YRoundToZero(Vector<float> value) {
                return WStatics.YRoundToZero(value.AsVector256()).AsVector();
            }
