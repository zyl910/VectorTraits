...
#if EX_APPLY_GENERIC
                var a0 = WStatics.YGroup2Unzip_Int128(data0.ExAsVector512(), data1.ExAsVector512(), out var a1);
                y = a1.ExAsVector();
                return a0.ExAsVector();
#else
                var a0 = WStatics.YGroup2Unzip_Int128(data0.AsVector512(), data1.AsVector512(), out var a1);
                y = a1.AsVector();
                return a0.AsVector();
...
#if EX_APPLY_GENERIC
                var a0 = WStatics.YGroup2Zip_Int128(x.ExAsVector512(), y.ExAsVector512(), out var a1);
                data1 = a1.ExAsVector();
                return a0.ExAsVector();
#else
                var a0 = WStatics.YGroup2Zip_Int128(x.AsVector512(), y.AsVector512(), out var a1);
                data1 = a1.AsVector();
                return a0.AsVector();
#endif // EX_APPLY_GENERIC
            }
...
#if EX_APPLY_GENERIC
                var a0 = WStatics.YGroup4Unzip_Int128(data0.ExAsVector512(), data1.ExAsVector512(), data2.ExAsVector512(), data3.ExAsVector512(), out var a1, out var a2, out var a3);
                y = a1.ExAsVector();
                z = a2.ExAsVector();
                w = a3.ExAsVector();
                return a0.ExAsVector();
#else
                var a0 = WStatics.YGroup4Unzip_Int128(data0.AsVector512(), data1.AsVector512(), data2.AsVector512(), data3.AsVector512(), out var a1, out var a2, out var a3);
                y = a1.AsVector();
                z = a2.AsVector();
                w = a3.AsVector();
                return a0.AsVector();
...
#if EX_APPLY_GENERIC
                var a0 = WStatics.YGroup4Zip_Int128(x.ExAsVector512(), y.ExAsVector512(), z.ExAsVector512(), w.ExAsVector512(), out var a1, out var a2, out var a3);
                data1 = a1.ExAsVector();
                data2 = a2.ExAsVector();
                data3 = a3.ExAsVector();
                return a0.ExAsVector();
#else
                var a0 = WStatics.YGroup4Zip_Int128(x.AsVector512(), y.AsVector512(), z.AsVector512(), w.AsVector512(), out var a1, out var a2, out var a3);
                data1 = a1.AsVector();
                data2 = a2.AsVector();
                data3 = a3.AsVector();
                return a0.AsVector();
