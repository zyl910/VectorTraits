    ...
    partial class VectorTraits256Avx2 {
        ...
        partial class Statics {
            ...
            public static Vector<float> YGroup1ToGroup3(Vector<float> x, out Vector<float> result1, out Vector<float> result2) {
                var a0 = WStatics.YGroup1ToGroup3(x.AsVector256(), out var a1, out var a2);
                result1 = a1.AsVector();
                result2 = a2.AsVector();
                return a0.AsVector();
            }
            ...
            public static Vector<float> YGroup1ToGroup4(Vector<float> x, out Vector<float> result1, out Vector<float> result2, out Vector<float> result3) {
                var a0 = WStatics.YGroup1ToGroup4(x.AsVector256(), out var a1, out var a2, out var a3);
                result1 = a1.AsVector();
                result2 = a2.AsVector();
                result3 = a3.AsVector();
                return a0.AsVector();
            ...
            public static Vector<float> YGroup1ToGroup4WithW(Vector<float> x, Vector<float> w, out Vector<float> result1, out Vector<float> result2, out Vector<float> result3) {
                var a0 = WStatics.YGroup1ToGroup4WithW(x.AsVector256(), w.AsVector256(), out var a1, out var a2, out var a3);
                result1 = a1.AsVector();
                result2 = a2.AsVector();
                result3 = a3.AsVector();
                return a0.AsVector();
            ...
            public static Vector<float> YGroup2Transpose(Vector<float> data0, Vector<float> data1, out Vector<float> result1) {
                var a0 = WStatics.YGroup2Transpose(data0.AsVector256(), data1.AsVector256(), out var a1);
                result1 = a1.AsVector();
                return a0.AsVector();
            }
            ...
            public static Vector<float> YGroup2TransposeEven(Vector<float> data0, Vector<float> data1) {
                return WStatics.YGroup2TransposeEven(data0.AsVector256(), data1.AsVector256()).AsVector();
            }
            ...
            public static Vector<float> YGroup2TransposeOdd(Vector<float> data0, Vector<float> data1) {
                return WStatics.YGroup2TransposeOdd(data0.AsVector256(), data1.AsVector256()).AsVector();
            }
            ...
            public static Vector<float> YGroup2Unzip(Vector<float> data0, Vector<float> data1, out Vector<float> y) {
                var a0 = WStatics.YGroup2Unzip(data0.AsVector256(), data1.AsVector256(), out var a1);
                y = a1.AsVector();
                return a0.AsVector();
            }
            ...
            public static Vector<ExInt128> YGroup2Unzip(Vector<ExInt128> data0, Vector<ExInt128> data1, out Vector<ExInt128> y) {
                var a0 = WStatics.YGroup2Unzip(data0.ExAsVector256(), data1.ExAsVector256(), out var a1);
                y = a1.ExAsVector();
...
#if EX_APPLY_GENERIC
                var a0 = WStatics.YGroup2Unzip_Bit128(data0.ExAsVector256(), data1.ExAsVector256(), out var a1);
                y = a1.ExAsVector();
                return a0.ExAsVector();
#else
                var a0 = WStatics.YGroup2Unzip_Bit128(data0.AsVector256(), data1.AsVector256(), out var a1);
                y = a1.AsVector();
                return a0.AsVector();
            ...
            public static Vector<float> YGroup2UnzipEven(Vector<float> data0, Vector<float> data1) {
                return WStatics.YGroup2UnzipEven(data0.AsVector256(), data1.AsVector256()).AsVector();
            }
            ...
            public static Vector<ExInt128> YGroup2UnzipEven(Vector<ExInt128> data0, Vector<ExInt128> data1) {
                return WStatics.YGroup2UnzipEven(data0.ExAsVector256(), data1.ExAsVector256()).ExAsVector();
            }
            ...
            public static Vector<float> YGroup2UnzipOdd(Vector<float> data0, Vector<float> data1) {
                return WStatics.YGroup2UnzipOdd(data0.AsVector256(), data1.AsVector256()).AsVector();
            }
            ...
            public static Vector<ExInt128> YGroup2UnzipOdd(Vector<ExInt128> data0, Vector<ExInt128> data1) {
                return WStatics.YGroup2UnzipOdd(data0.ExAsVector256(), data1.ExAsVector256()).ExAsVector();
            }
            ...
            public static Vector<float> YGroup2Zip(Vector<float> x, Vector<float> y, out Vector<float> data1) {
                var a0 = WStatics.YGroup2Zip(x.AsVector256(), y.AsVector256(), out var a1);
                data1 = a1.AsVector();
                return a0.AsVector();
            }
            ...
            public static Vector<ExInt128> YGroup2Zip(Vector<ExInt128> x, Vector<ExInt128> y, out Vector<ExInt128> data1) {
                var a0 = WStatics.YGroup2Zip(x.ExAsVector256(), y.ExAsVector256(), out var a1);
                data1 = a1.ExAsVector();
                return a0.ExAsVector();
            }
...
#if EX_APPLY_GENERIC
                var a0 = WStatics.YGroup2Zip_Bit128(x.ExAsVector256(), y.ExAsVector256(), out var a1);
                data1 = a1.ExAsVector();
                return a0.ExAsVector();
#else
                var a0 = WStatics.YGroup2Zip_Bit128(x.AsVector256(), y.AsVector256(), out var a1);
                data1 = a1.AsVector();
                return a0.AsVector();
#endif // EX_APPLY_GENERIC
            }
            ...
            public static Vector<float> YGroup2ZipHigh(Vector<float> x, Vector<float> y) {
                return WStatics.YGroup2ZipHigh(x.AsVector256(), y.AsVector256()).AsVector();
            }
            ...
            public static Vector<ExInt128> YGroup2ZipHigh(Vector<ExInt128> x, Vector<ExInt128> y) {
                return WStatics.YGroup2ZipHigh(x.ExAsVector256(), y.ExAsVector256()).ExAsVector();
            }
            ...
            public static Vector<float> YGroup2ZipLow(Vector<float> x, Vector<float> y) {
                return WStatics.YGroup2ZipLow(x.AsVector256(), y.AsVector256()).AsVector();
            }
            ...
            public static Vector<ExInt128> YGroup2ZipLow(Vector<ExInt128> x, Vector<ExInt128> y) {
                return WStatics.YGroup2ZipLow(x.ExAsVector256(), y.ExAsVector256()).ExAsVector();
            }
            ...
            public static Vector<float> YGroup3ToGroup4(Vector<float> data0, Vector<float> data1, Vector<float> data2, out Vector<float> result1, out Vector<float> result2, out Vector<float> result3) {
                var a0 = WStatics.YGroup3ToGroup4(data0.AsVector256(), data1.AsVector256(), data2.AsVector256(), out var a1, out var a2, out var a3);
                result1 = a1.AsVector();
                result2 = a2.AsVector();
                result3 = a3.AsVector();
                return a0.AsVector();
            ...
            public static Vector<float> YGroup3Unzip(Vector<float> data0, Vector<float> data1, Vector<float> data2, out Vector<float> y, out Vector<float> z) {
                var a0 = WStatics.YGroup3Unzip(data0.AsVector256(), data1.AsVector256(), data2.AsVector256(), out var a1, out var a2);
                y = a1.AsVector();
                z = a2.AsVector();
                return a0.AsVector();
            }
            ...
            public static Vector<T> YGroup3Unzip_Bit128<T>(Vector<T> data0, Vector<T> data1, Vector<T> data2, out Vector<T> y, out Vector<T> z) where T : struct {
                var a0 = WStatics.YGroup3Unzip_Bit128(data0.AsVector256(), data1.AsVector256(), data2.AsVector256(), out var a1, out var a2);
                y = a1.AsVector();
                z = a2.AsVector();
                return a0.AsVector();
            }
            ...
            public static Vector<float> YGroup3UnzipX2(Vector<float> data0, Vector<float> data1, Vector<float> data2, Vector<float> data3, Vector<float> data4, Vector<float> data5, out Vector<float> xB, out Vector<float> y, out Vector<float> yB, out Vector<float> z, out Vector<float> zB) {
                var a0 = WStatics.YGroup3UnzipX2(data0.AsVector256(), data1.AsVector256(), data2.AsVector256(), data3.AsVector256(), data4.AsVector256(), data5.AsVector256(), out var a1, out var a2, out var a3, out var a4, out var a5);
                xB = a1.AsVector();
                y = a2.AsVector();
                yB = a3.AsVector();
                z = a4.AsVector();
            ...
            public static Vector<T> YGroup3UnzipX2_Bit128<T>(Vector<T> data0, Vector<T> data1, Vector<T> data2, Vector<T> data3, Vector<T> data4, Vector<T> data5, out Vector<T> xB, out Vector<T> y, out Vector<T> yB, out Vector<T> z, out Vector<T> zB) where T : struct {
                var a0 = WStatics.YGroup3UnzipX2_Bit128(data0.AsVector256(), data1.AsVector256(), data2.AsVector256(), data3.AsVector256(), data4.AsVector256(), data5.AsVector256(), out var a1, out var a2, out var a3, out var a4, out var a5);
                xB = a1.AsVector();
                y = a2.AsVector();
                yB = a3.AsVector();
                z = a4.AsVector();
            ...
            public static Vector<float> YGroup3Zip(Vector<float> x, Vector<float> y, Vector<float> z, out Vector<float> data1, out Vector<float> data2) {
                var a0 = WStatics.YGroup3Zip(x.AsVector256(), y.AsVector256(), z.AsVector256(), out var a1, out var a2);
                data1 = a1.AsVector();
                data2 = a2.AsVector();
                return a0.AsVector();
            }
            ...
            public static Vector<T> YGroup3Zip_Bit128<T>(Vector<T> x, Vector<T> y, Vector<T> z, out Vector<T> data1, out Vector<T> data2) where T : struct {
                var a0 = WStatics.YGroup3Zip_Bit128(x.AsVector256(), y.AsVector256(), z.AsVector256(), out var a1, out var a2);
                data1 = a1.AsVector();
                data2 = a2.AsVector();
                return a0.AsVector();
            }
            ...
            public static Vector<float> YGroup3ZipX2(Vector<float> x, Vector<float> xB, Vector<float> y, Vector<float> yB, Vector<float> z, Vector<float> zB, out Vector<float> data1, out Vector<float> data2, out Vector<float> data3, out Vector<float> data4, out Vector<float> data5) {
                var a0 = WStatics.YGroup3ZipX2(x.AsVector256(), xB.AsVector256(), y.AsVector256(), yB.AsVector256(), z.AsVector256(), zB.AsVector256(), out var a1, out var a2, out var a3, out var a4, out var a5);
                data1 = a1.AsVector();
                data2 = a2.AsVector();
                data3 = a3.AsVector();
                data4 = a4.AsVector();
            ...
            public static Vector<T> YGroup3ZipX2_Bit128<T>(Vector<T> x, Vector<T> xB, Vector<T> y, Vector<T> yB, Vector<T> z, Vector<T> zB, out Vector<T> data1, out Vector<T> data2, out Vector<T> data3, out Vector<T> data4, out Vector<T> data5) where T : struct {
                var a0 = WStatics.YGroup3ZipX2_Bit128(x.AsVector256(), xB.AsVector256(), y.AsVector256(), yB.AsVector256(), z.AsVector256(), zB.AsVector256(), out var a1, out var a2, out var a3, out var a4, out var a5);
                data1 = a1.AsVector();
                data2 = a2.AsVector();
                data3 = a3.AsVector();
                data4 = a4.AsVector();
            ...
            public static Vector<float> YGroup4ToGroup3(Vector<float> data0, Vector<float> data1, Vector<float> data2, Vector<float> data3, out Vector<float> result1, out Vector<float> result2) {
                var a0 = WStatics.YGroup4ToGroup3(data0.AsVector256(), data1.AsVector256(), data2.AsVector256(), data3.AsVector256(), out var a1, out var a2);
                result1 = a1.AsVector();
                result2 = a2.AsVector();
                return a0.AsVector();
            }
            ...
            public static Vector<float> YGroup4Unzip(Vector<float> data0, Vector<float> data1, Vector<float> data2, Vector<float> data3, out Vector<float> y, out Vector<float> z, out Vector<float> w) {
                var a0 = WStatics.YGroup4Unzip(data0.AsVector256(), data1.AsVector256(), data2.AsVector256(), data3.AsVector256(), out var a1, out var a2, out var a3);
                y = a1.AsVector();
                z = a2.AsVector();
                w = a3.AsVector();
                return a0.AsVector();
            ...
            public static Vector<ExInt128> YGroup4Unzip(Vector<ExInt128> data0, Vector<ExInt128> data1, Vector<ExInt128> data2, Vector<ExInt128> data3, out Vector<ExInt128> y, out Vector<ExInt128> z, out Vector<ExInt128> w) {
                var a0 = WStatics.YGroup4Unzip(data0.ExAsVector256(), data1.ExAsVector256(), data2.ExAsVector256(), data3.ExAsVector256(), out var a1, out var a2, out var a3);
                y = a1.ExAsVector();
                z = a2.ExAsVector();
                w = a3.ExAsVector();
                return a0.ExAsVector();
...
#if EX_APPLY_GENERIC
                var a0 = WStatics.YGroup4Unzip_Bit128(data0.ExAsVector256(), data1.ExAsVector256(), data2.ExAsVector256(), data3.ExAsVector256(), out var a1, out var a2, out var a3);
                y = a1.ExAsVector();
                z = a2.ExAsVector();
                w = a3.ExAsVector();
                return a0.ExAsVector();
#else
                var a0 = WStatics.YGroup4Unzip_Bit128(data0.AsVector256(), data1.AsVector256(), data2.AsVector256(), data3.AsVector256(), out var a1, out var a2, out var a3);
                y = a1.AsVector();
                z = a2.AsVector();
                w = a3.AsVector();
                return a0.AsVector();
            ...
            public static Vector<float> YGroup4Zip(Vector<float> x, Vector<float> y, Vector<float> z, Vector<float> w, out Vector<float> data1, out Vector<float> data2, out Vector<float> data3) {
                var a0 = WStatics.YGroup4Zip(x.AsVector256(), y.AsVector256(), z.AsVector256(), w.AsVector256(), out var a1, out var a2, out var a3);
                data1 = a1.AsVector();
                data2 = a2.AsVector();
                data3 = a3.AsVector();
                return a0.AsVector();
            ...
            public static Vector<ExInt128> YGroup4Zip(Vector<ExInt128> x, Vector<ExInt128> y, Vector<ExInt128> z, Vector<ExInt128> w, out Vector<ExInt128> data1, out Vector<ExInt128> data2, out Vector<ExInt128> data3) {
                var a0 = WStatics.YGroup4Zip(x.ExAsVector256(), y.ExAsVector256(), z.ExAsVector256(), w.ExAsVector256(), out var a1, out var a2, out var a3);
                data1 = a1.ExAsVector();
                data2 = a2.ExAsVector();
                data3 = a3.ExAsVector();
                return a0.ExAsVector();
...
#if EX_APPLY_GENERIC
                var a0 = WStatics.YGroup4Zip_Bit128(x.ExAsVector256(), y.ExAsVector256(), z.ExAsVector256(), w.ExAsVector256(), out var a1, out var a2, out var a3);
                data1 = a1.ExAsVector();
                data2 = a2.ExAsVector();
                data3 = a3.ExAsVector();
                return a0.ExAsVector();
#else
                var a0 = WStatics.YGroup4Zip_Bit128(x.AsVector256(), y.AsVector256(), z.AsVector256(), w.AsVector256(), out var a1, out var a2, out var a3);
                data1 = a1.AsVector();
                data2 = a2.AsVector();
                data3 = a3.AsVector();
                return a0.AsVector();
