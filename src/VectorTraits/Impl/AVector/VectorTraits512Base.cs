...
namespace Zyl.VectorTraits.Impl.AVector {
    ...
    /// <summary>
    /// <see cref="Vector{T}"/> traits 512 - base.
    /// </summary>
    public sealed partial class VectorTraits512Base : VectorTraits512Abstract {
        private static readonly VectorTraits512Base _instance = new VectorTraits512Base(); // Default instance.

        /// <summary>Default instance. </summary>
        public static VectorTraits512Base Instance {
            get { return _instance; }
        }

        /// <summary>
        /// <see cref="Vector{T}"/> traits.Statics 512 - base.
        /// </summary>
        public static partial class Statics {
            ...
            public static bool IsHardwareAccelerated {
                get {
                    return IsSupported && Vector.IsHardwareAccelerated;
                }
            }
