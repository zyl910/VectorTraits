...
namespace Zyl.VectorTraits.ExTypes.Impl {
    ...
    internal static partial class FormattingHelpers {
        ...
        public static int CountDigits(ExUInt128 value) {
            ...
            if (upper > 5) {
                ...
                value /= new ExUInt128(0x5, 0x6BC7_5E2D_6310_0000); // value /= 1e20
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static int CountHexDigits(ExUInt128 value) {
            // The number of hex digits is log16(value) + 1, or log2(value) / 4 + 1
            return ((int)ExUInt128.Log2(value) >> 2) + 1;
        }
    }
