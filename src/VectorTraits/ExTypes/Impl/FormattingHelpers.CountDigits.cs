...
namespace Zyl.VectorTraits.ExTypes.Impl {
    internal static partial class FormattingHelpers {
        ...
        public static int CountDigits(ulong value) {
            ...
            uint index = Unsafe.Add(ref MemoryMarshal.GetReference(log2ToPow10), MathBitOperations.Log2(value));
            ...
            ulong powerOf10 = Unsafe.Add(ref MemoryMarshal.GetReference(powersOf10), (nint)index);
        ...
        public static int CountDigits(uint value) {
            ...
            long tableValue = Unsafe.Add(ref MemoryMarshal.GetReference(table), MathBitOperations.Log2(value));
        ...
        public static int CountHexDigits(ulong value) {
            ...
            return (MathBitOperations.Log2(value) >> 2) + 1;
        }
