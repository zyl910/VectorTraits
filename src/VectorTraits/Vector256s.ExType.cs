...
namespace Zyl.VectorTraits {
    partial class Vector256s {
        ...
        /// <returns>A new <see cref="Vector256{T}" /> with all elements initialized to <paramref name="value" /> (一个新向量，它的所有元素都初始化为 <paramref name="value" />).</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector256<ExInt128> Create(ExInt128 value) {
            var a = Unsafe.As<ExInt128, Vector128<ulong>>(ref value);
            //var b = a.ToVector256Unsafe().WithUpper(a);
            var b = Vector256.Create(a, a);
            return b.ExAsExInt128();
        }
        ...
        [CLSCompliant(false)]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector256<ExUInt128> Create(ExUInt128 value) {
            var a = Unsafe.As<ExUInt128, Vector128<ulong>>(ref value);
            var b = Vector256.Create(a, a);
            return b.ExAsExUInt128();
        }
        ...
        /// <returns>A new <see cref="Vector256{T}" /> with each element initialized to corresponding specified value (一个新向量，其中每个元素都初始化为相应的指定值).</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector256<ExInt128> Create(ExInt128 e0, ExInt128 e1) {
            var a0 = Unsafe.As<ExInt128, Vector128<ulong>>(ref e0);
            var a1 = Unsafe.As<ExInt128, Vector128<ulong>>(ref e1);
            //var b = a0.ToVector256Unsafe().WithUpper(a1);
            var b = Vector256.Create(a0, a1);
            return b.ExAsExInt128();
        }
        ...
        [CLSCompliant(false)]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector256<ExUInt128> Create(ExUInt128 e0, ExUInt128 e1) {
        ...
        /// <returns>A new <see cref="Vector256{T}" /> with all elements initialized to <paramref name="value" /> (一个新向量，它的所有元素都初始化为 <paramref name="value" />).</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector256<Int128> Create(Int128 value) {
        ...
        [CLSCompliant(false)]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector256<UInt128> Create(UInt128 value) {
            var a = Unsafe.As<UInt128, Vector128<ulong>>(ref value);
            var b = Vector256.Create(a, a);
            return b.ExAsUInt128();
        }
        ...
        /// <returns>A new <see cref="Vector256{T}" /> with each element initialized to corresponding specified value (一个新向量，其中每个元素都初始化为相应的指定值).</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector256<Int128> Create(Int128 e0, Int128 e1) {
        ...
        [CLSCompliant(false)]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector256<UInt128> Create(UInt128 e0, UInt128 e1) {
        ...
        /// <returns>A new <see cref="Vector256{T}" /> instance with the first element initialized to <paramref name="value" /> and the remaining elements initialized to zero (一个新的向量实例，其中首个元素初始化为 <paramref name="value" />，其余元素初始化为零).</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector256<ExInt128> CreateScalar(ExInt128 value) {
            var a = Unsafe.As<ExInt128, Vector128<ulong>>(ref value);
            var b = a.ToVector256();
            return b.ExAsExInt128();
        }
        ...
        [CLSCompliant(false)]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector256<ExUInt128> CreateScalar(ExUInt128 value) {
            var a = Unsafe.As<ExUInt128, Vector128<ulong>>(ref value);
            var b = a.ToVector256();
            return b.ExAsExUInt128();
        }
        ...
        /// <returns>A new <see cref="Vector256{T}" /> instance with the first element initialized to <paramref name="value" /> and the remaining elements initialized to zero (一个新的向量实例，其中首个元素初始化为 <paramref name="value" />，其余元素初始化为零).</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector256<Int128> CreateScalar(Int128 value) {
            var a = Unsafe.As<Int128, Vector128<ulong>>(ref value);
            var b = a.ToVector256();
            return b.ExAsInt128();
        }
        ...
        [CLSCompliant(false)]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector256<UInt128> CreateScalar(UInt128 value) {
            var a = Unsafe.As<UInt128, Vector128<ulong>>(ref value);
            var b = a.ToVector256();
            return b.ExAsUInt128();
        }
        ...
        /// <param name="value">The value that element 0 will be initialized to (元素 0 的初始化值).</param>
        /// <returns>A new <see cref="Vector256{T}" /> instance with the first element initialized to <paramref name="value" /> and the remaining elements left uninitialized (一个新的向量实例，其中首个元素初始化为 <paramref name="value" />，其余元素未初始化).</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector256<ExInt128> CreateScalarUnsafe(ExInt128 value) {
            var a = Unsafe.As<ExInt128, Vector128<ulong>>(ref value);
        ...
        [CLSCompliant(false)]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector256<ExUInt128> CreateScalarUnsafe(ExUInt128 value) {
            var a = Unsafe.As<ExUInt128, Vector128<ulong>>(ref value);
            var b = a.ToVector256Unsafe();
            return b.ExAsExUInt128();
        }
        ...
        /// <returns>A new <see cref="Vector256{T}" /> instance with the first element initialized to <paramref name="value" /> and the remaining elements left uninitialized (一个新的向量实例，其中首个元素初始化为 <paramref name="value" />，其余元素未初始化).</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector256<Int128> CreateScalarUnsafe(Int128 value) {
            var a = Unsafe.As<Int128, Vector128<ulong>>(ref value);
            var b = a.ToVector256Unsafe();
            return b.ExAsInt128();
        }
        ...
        [CLSCompliant(false)]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector256<UInt128> CreateScalarUnsafe(UInt128 value) {
            var a = Unsafe.As<UInt128, Vector128<ulong>>(ref value);
            var b = a.ToVector256Unsafe();
            return b.ExAsUInt128();
        }
