...
namespace Zyl.VectorTraits.Tuples {
    /// <summary>
    /// Represents a <see cref="Vector256"/> tuple with 4 components (表示具有4个组件的向量256元组).
    /// </summary>
    ...
    public struct Vector256X4<T> : IEquatable<Vector256X4<T>>, IStructuralEquatable, IStructuralComparable, IComparable, IComparable<Vector256X4<T>>
...
#if NETCOREAPP3_0_OR_GREATER
        public ValueTuple<Vector256<T>, Vector256<T>, Vector256<T>, Vector256<T>> Val;
        ...
        public Vector256X4((Vector256<T>, Vector256<T>, Vector256<T>, Vector256<T>) val) {
            Val = val;
        }
#else
        public ValueTuple<byte, byte, byte, byte> Val;
#endif // NETCOREAPP3_0_OR_GREATER
        ...
        /// <inheritdoc/>
        public readonly int CompareTo(Vector256X4<T> other) {
        ...
        public override readonly bool Equals(object? obj) {
            return obj is Vector256X4<T> x &&
                   Val.Equals(x.Val);
        }

        /// <inheritdoc/>
        public readonly bool Equals(Vector256X4<T> other) {
...
#if NETCOREAPP3_0_OR_GREATER
        /// <summary>
        /// An implicit operator to convert a Vector256X4 value to a ValueTuple.
        /// </summary>
        /// <param name="src">Source value.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ValueTuple<Vector256<T>, Vector256<T>, Vector256<T>, Vector256<T>>(Vector256X4<T> src) {
            return src.Val;
        }

        /// <summary>
        /// An explicit operator to convert a ValueTuple value to a Vector256X4.
        /// </summary>
        /// <param name="src">Source value.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator Vector256X4<T>(ValueTuple<Vector256<T>, Vector256<T>, Vector256<T>, Vector256<T>> src) {
            return new Vector256X4<T>(src);
        }
#endif // NETCOREAPP3_0_OR_GREATER

        /// <inheritdoc/>
        public static bool operator ==(Vector256X4<T> left, Vector256X4<T> right) {
