...
namespace Zyl.VectorTraits.Tuples {
    /// <summary>
    /// Represents a <see cref="Vector"/> tuple with 6 components (表示具有6个组件的向量元组).
    /// </summary>
    ...
    public struct VectorX6<T> : IEquatable<VectorX6<T>>, IFormattable, IStructuralEquatable, IStructuralComparable, IComparable, IComparable<VectorX6<T>>
#if NET471_OR_GREATER || NETSTANDARD2_1_OR_GREATER || NETCOREAPP2_0_OR_GREATER
            , ITuple
#endif
            where T : struct {
        /// <summary>Value.</summary>
        public ValueTuple<Vector<T>, Vector<T>, Vector<T>, Vector<T>, Vector<T>, Vector<T>> Val;
        ...
        public VectorX6((Vector<T>, Vector<T>, Vector<T>, Vector<T>, Vector<T>, Vector<T>) val) {
            Val = val;
        }
        ...
        /// <inheritdoc/>
        public readonly int CompareTo(VectorX6<T> other) {
        ...
        public override readonly bool Equals(object? obj) {
            return obj is VectorX6<T> x &&
                   Val.Equals(x.Val);
        }

        /// <inheritdoc/>
        public readonly bool Equals(VectorX6<T> other) {
        ...
        /// <summary>
        /// An implicit operator to convert a VectorX6 value to a ValueTuple.
        /// </summary>
        /// <param name="src">Source value.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ValueTuple<Vector<T>, Vector<T>, Vector<T>, Vector<T>, Vector<T>, Vector<T>>(VectorX6<T> src) {
            return src.Val;
        }

        /// <summary>
        /// An explicit operator to convert a ValueTuple value to a VectorX6.
        /// </summary>
        /// <param name="src">Source value.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator VectorX6<T>(ValueTuple<Vector<T>, Vector<T>, Vector<T>, Vector<T>, Vector<T>, Vector<T>> src) {
            return new VectorX6<T>(src);
        }

        /// <inheritdoc/>
        public static bool operator ==(VectorX6<T> left, VectorX6<T> right) {
