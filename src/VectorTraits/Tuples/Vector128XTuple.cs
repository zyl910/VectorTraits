...
namespace Zyl.VectorTraits.Tuples {
    ...
    public static partial class Vector128XTuple {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector128X3<T> Create<T>(Vector128<T> item1, Vector128<T> item2, Vector128<T> item3) where T : struct {
            return new Vector128X3<T>((item1, item2, item3));
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector128X4<T> Create<T>(Vector128<T> item1, Vector128<T> item2, Vector128<T> item3, Vector128<T> item4) where T : struct {
            return new Vector128X4<T>((item1, item2, item3, item4));
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector128X5<T> Create<T>(Vector128<T> item1, Vector128<T> item2, Vector128<T> item3, Vector128<T> item4, Vector128<T> item5) where T : struct {
            return new Vector128X5<T>((item1, item2, item3, item4, item5));
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector128X6<T> Create<T>(Vector128<T> item1, Vector128<T> item2, Vector128<T> item3, Vector128<T> item4, Vector128<T> item5, Vector128<T> item6) where T : struct {
            return new Vector128X6<T>((item1, item2, item3, item4, item5, item6));
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector128X7<T> Create<T>(Vector128<T> item1, Vector128<T> item2, Vector128<T> item3, Vector128<T> item4, Vector128<T> item5, Vector128<T> item6, Vector128<T> item7) where T : struct {
            return new Vector128X7<T>((item1, item2, item3, item4, item5, item6, item7));
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector128X8<T> Create<T>(Vector128<T> item1, Vector128<T> item2, Vector128<T> item3, Vector128<T> item4, Vector128<T> item5, Vector128<T> item6, Vector128<T> item7, Vector128<T> item8) where T : struct {
            return new Vector128X8<T>((item1, item2, item3, item4, item5, item6, item7, item8));
        }
        ...
        /// <returns>A vector tuple with 3 components (具有3个组件的向量元组).</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector128X3<T> Create<T>((Vector128<T>, Vector128<T>, Vector128<T>) val) where T : struct {
            return new Vector128X3<T>(val);
        }
        ...
        /// <returns>A vector tuple with 4 components (具有4个组件的向量元组).</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector128X4<T> Create<T>((Vector128<T>, Vector128<T>, Vector128<T>, Vector128<T>) val) where T : struct {
            return new Vector128X4<T>(val);
        }
        ...
        /// <returns>A vector tuple with 5 components (具有5个组件的向量元组).</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector128X5<T> Create<T>((Vector128<T>, Vector128<T>, Vector128<T>, Vector128<T>, Vector128<T>) val) where T : struct {
            return new Vector128X5<T>(val);
        }
        ...
        /// <returns>A vector tuple with 6 components (具有6个组件的向量元组).</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector128X6<T> Create<T>((Vector128<T>, Vector128<T>, Vector128<T>, Vector128<T>, Vector128<T>, Vector128<T>) val) where T : struct {
            return new Vector128X6<T>(val);
        }
        ...
        /// <returns>A vector tuple with 7 components (具有7个组件的向量元组).</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector128X7<T> Create<T>((Vector128<T>, Vector128<T>, Vector128<T>, Vector128<T>, Vector128<T>, Vector128<T>, Vector128<T>) val) where T : struct {
            return new Vector128X7<T>(val);
        }
        ...
        /// <returns>A vector tuple with 8 components (具有8个组件的向量元组).</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vector128X8<T> Create<T>((Vector128<T>, Vector128<T>, Vector128<T>, Vector128<T>, Vector128<T>, Vector128<T>, Vector128<T>, Vector128<T>) val) where T : struct {
            return new Vector128X8<T>(val);
        }
