...
namespace Zyl.VectorTraits.Tuples {
    /// <summary>
    /// Represents a <see cref="Vector256"/> tuple with 6 components (表示具有6个组件的向量256元组).
    /// </summary>
    ...
    public struct Vector256X6<T> : IEquatable<Vector256X6<T>>, IStructuralEquatable, IStructuralComparable, IComparable, IComparable<Vector256X6<T>>
...
#if NETCOREAPP3_0_OR_GREATER
        public ValueTuple<Vector256<T>, Vector256<T>, Vector256<T>, Vector256<T>, Vector256<T>, Vector256<T>> Val;
        ...
        public Vector256X6((Vector256<T>, Vector256<T>, Vector256<T>, Vector256<T>, Vector256<T>, Vector256<T>) val) {
            Val = val;
        }
#else
        ...
        /// <inheritdoc/>
        public readonly int CompareTo(Vector256X6<T> other) {
        ...
        public override readonly bool Equals(object? obj) {
            return obj is Vector256X6<T> x &&
                   Val.Equals(x.Val);
        }

        /// <inheritdoc/>
        public readonly bool Equals(Vector256X6<T> other) {
...
#if NETCOREAPP3_0_OR_GREATER
        /// <summary>
        /// An implicit operator to convert a Vector256X6 value to a ValueTuple.
        /// </summary>
        /// <param name="src">Source value.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ValueTuple<Vector256<T>, Vector256<T>, Vector256<T>, Vector256<T>, Vector256<T>, Vector256<T>>(Vector256X6<T> src) {
            return src.Val;
        }

        /// <summary>
        /// An explicit operator to convert a ValueTuple value to a Vector256X6.
        /// </summary>
        /// <param name="src">Source value.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator Vector256X6<T>(ValueTuple<Vector256<T>, Vector256<T>, Vector256<T>, Vector256<T>, Vector256<T>, Vector256<T>> src) {
            return new Vector256X6<T>(src);
        }
#endif // NETCOREAPP3_0_OR_GREATER

        /// <inheritdoc/>
        public static bool operator ==(Vector256X6<T> left, Vector256X6<T> right) {
