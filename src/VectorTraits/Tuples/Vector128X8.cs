...
namespace Zyl.VectorTraits.Tuples {
    /// <summary>
    /// Represents a <see cref="Vector128"/> tuple with 8 components (表示具有8个组件的向量128元组).
    /// </summary>
    ...
    public struct Vector128X8<T> : IEquatable<Vector128X8<T>>, IStructuralEquatable, IStructuralComparable, IComparable, IComparable<Vector128X8<T>>
...
#if NETCOREAPP3_0_OR_GREATER
        public (Vector128<T>, Vector128<T>, Vector128<T>, Vector128<T>, Vector128<T>, Vector128<T>, Vector128<T>, Vector128<T>) Val;
        ...
        public Vector128X8((Vector128<T>, Vector128<T>, Vector128<T>, Vector128<T>, Vector128<T>, Vector128<T>, Vector128<T>, Vector128<T>) val) {
            Val = val;
        }
#else
        ...
        /// <inheritdoc/>
        public readonly int CompareTo(Vector128X8<T> other) {
        ...
        public override readonly bool Equals(object? obj) {
            return obj is Vector128X8<T> x &&
                   Val.Equals(x.Val);
        }

        /// <inheritdoc/>
        public readonly bool Equals(Vector128X8<T> other) {
...
#if NETCOREAPP3_0_OR_GREATER
        /// <summary>
        /// An implicit operator to convert a Vector128X8 value to a ValueTuple.
        /// </summary>
        /// <param name="src">Source value.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator (Vector128<T>, Vector128<T>, Vector128<T>, Vector128<T>, Vector128<T>, Vector128<T>, Vector128<T>, Vector128<T>)(Vector128X8<T> src) {
            return src.Val;
        }

        /// <summary>
        /// An explicit operator to convert a ValueTuple value to a Vector128X8.
        /// </summary>
        /// <param name="src">Source value.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator Vector128X8<T>((Vector128<T>, Vector128<T>, Vector128<T>, Vector128<T>, Vector128<T>, Vector128<T>, Vector128<T>, Vector128<T>) src) {
            return new Vector128X8<T>(src);
        }
#endif // NETCOREAPP3_0_OR_GREATER

        /// <inheritdoc/>
        public static bool operator ==(Vector128X8<T> left, Vector128X8<T> right) {
