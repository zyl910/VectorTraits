...
namespace Zyl.VectorTraits.Tuples {
    /// <summary>
    /// Represents a <see cref="Vector"/> tuple with 3 components (表示具有3个组件的向量元组).
    /// </summary>
    ...
    public struct VectorX3<T> : IEquatable<VectorX3<T>>, IFormattable, IStructuralEquatable, IStructuralComparable, IComparable, IComparable<VectorX3<T>>
#if NET471_OR_GREATER || NETSTANDARD2_1_OR_GREATER || NETCOREAPP2_0_OR_GREATER
            , ITuple
#endif
            where T : struct {
        /// <summary>Value.</summary>
        public ValueTuple<Vector<T>, Vector<T>, Vector<T>> Val;
        ...
        public VectorX3((Vector<T>, Vector<T>, Vector<T>) val) {
            Val = val;
        }
        ...
        /// <inheritdoc/>
        public readonly int CompareTo(VectorX3<T> other) {
        ...
        public override readonly bool Equals(object? obj) {
            return obj is VectorX3<T> x &&
                   Val.Equals(x.Val);
        }

        /// <inheritdoc/>
        public readonly bool Equals(VectorX3<T> other) {
        ...
        /// <summary>
        /// An implicit operator to convert a VectorX3 value to a ValueTuple.
        /// </summary>
        /// <param name="src">Source value.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ValueTuple<Vector<T>, Vector<T>, Vector<T>>(VectorX3<T> src) {
            return src.Val;
        }

        /// <summary>
        /// An explicit operator to convert a ValueTuple value to a VectorX3.
        /// </summary>
        /// <param name="src">Source value.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator VectorX3<T>(ValueTuple<Vector<T>, Vector<T>, Vector<T>> src) {
            return new VectorX3<T>(src);
        }

        /// <inheritdoc/>
        public static bool operator ==(VectorX3<T> left, VectorX3<T> right) {
