...
namespace Zyl.VectorTraits.Tuples {
    /// <summary>
    /// Represents a <see cref="Vector128"/> tuple with 7 components (表示具有7个组件的向量128元组).
    /// </summary>
    ...
    public struct Vector128X7<T> : IEquatable<Vector128X7<T>>, IStructuralEquatable, IStructuralComparable, IComparable, IComparable<Vector128X7<T>>
...
#if NETCOREAPP3_0_OR_GREATER
        public ValueTuple<Vector128<T>, Vector128<T>, Vector128<T>, Vector128<T>, Vector128<T>, Vector128<T>, Vector128<T>> Val;
        ...
        public Vector128X7((Vector128<T>, Vector128<T>, Vector128<T>, Vector128<T>, Vector128<T>, Vector128<T>, Vector128<T>) val) {
            Val = val;
        }
#else
        public ValueTuple<byte, byte, byte, byte, byte, byte, byte> Val;
#endif // NETCOREAPP3_0_OR_GREATER
        ...
        /// <inheritdoc/>
        public readonly int CompareTo(Vector128X7<T> other) {
        ...
        public override readonly bool Equals(object? obj) {
            return obj is Vector128X7<T> x &&
                   Val.Equals(x.Val);
        }

        /// <inheritdoc/>
        public readonly bool Equals(Vector128X7<T> other) {
...
#if NETCOREAPP3_0_OR_GREATER
        /// <summary>
        /// An implicit operator to convert a Vector128X7 value to a ValueTuple.
        /// </summary>
        /// <param name="src">Source value.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ValueTuple<Vector128<T>, Vector128<T>, Vector128<T>, Vector128<T>, Vector128<T>, Vector128<T>, Vector128<T>>(Vector128X7<T> src) {
            return src.Val;
        }

        /// <summary>
        /// An explicit operator to convert a ValueTuple value to a Vector128X7.
        /// </summary>
        /// <param name="src">Source value.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator Vector128X7<T>(ValueTuple<Vector128<T>, Vector128<T>, Vector128<T>, Vector128<T>, Vector128<T>, Vector128<T>, Vector128<T>> src) {
            return new Vector128X7<T>(src);
        }
#endif // NETCOREAPP3_0_OR_GREATER

        /// <inheritdoc/>
        public static bool operator ==(Vector128X7<T> left, Vector128X7<T> right) {
