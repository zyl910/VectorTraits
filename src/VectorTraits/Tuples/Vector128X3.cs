...
namespace Zyl.VectorTraits.Tuples {
    /// <summary>
    /// Represents a <see cref="Vector128"/> tuple with 3 components (表示具有3个组件的向量128元组).
    /// </summary>
    ...
    public struct Vector128X3<T> : IEquatable<Vector128X3<T>>, IStructuralEquatable, IStructuralComparable, IComparable, IComparable<Vector128X3<T>>
...
#if NETCOREAPP3_0_OR_GREATER
        public ValueTuple<Vector128<T>, Vector128<T>, Vector128<T>> Val;
        ...
        public Vector128X3((Vector128<T>, Vector128<T>, Vector128<T>) val) {
            Val = val;
        }
#else
        ...
        /// <inheritdoc/>
        public readonly int CompareTo(Vector128X3<T> other) {
        ...
        public override readonly bool Equals(object? obj) {
            return obj is Vector128X3<T> x &&
                   Val.Equals(x.Val);
        }

        /// <inheritdoc/>
        public readonly bool Equals(Vector128X3<T> other) {
...
#if NETCOREAPP3_0_OR_GREATER
        /// <summary>
        /// An implicit operator to convert a Vector128X3 value to a ValueTuple.
        /// </summary>
        /// <param name="src">Source value.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator ValueTuple<Vector128<T>, Vector128<T>, Vector128<T>>(Vector128X3<T> src) {
            return src.Val;
        }

        /// <summary>
        /// An explicit operator to convert a ValueTuple value to a Vector128X3.
        /// </summary>
        /// <param name="src">Source value.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator Vector128X3<T>(ValueTuple<Vector128<T>, Vector128<T>, Vector128<T>> src) {
            return new Vector128X3<T>(src);
        }
#endif // NETCOREAPP3_0_OR_GREATER

        /// <inheritdoc/>
        public static bool operator ==(Vector128X3<T> left, Vector128X3<T> right) {
